...
const char* RPGConfig::TAP_ON_CLICKABLE_OBJECT_NOTIFICATION = "TAP_ON_CLICKABLE_OBJECT_NOTIFICATION";

const char* RPGConfig::DISPATCH_CLEANUP_AND_SCENE_TRANSITION_NOTIFICATION = "DISPATCH_CLEANUP_AND_SCENE_TRANSITION_NOTIFICATION";
