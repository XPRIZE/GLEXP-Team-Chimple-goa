...
var AlphabetsMenu = cc.Layer.extend({
    ...
    ctor:function () {
        ...
        this.LevelBox1button = new ClickedButtonToRedirect("Orange_LevelBall.png","alpha",1);
        ...
        this.LevelBox3button = new ClickedButtonToRedirect("Orange_LevelBall.png","alpha",3);
        ...
        this.LevelBox5button = new ClickedButtonToRedirect("Orange_LevelBall.png","alpha",5);
        ...
        this.LevelBox7button = new ClickedButtonToRedirect("Orange_LevelBall.png","alpha",7);
        ...
        this.LevelBox9button = new ClickedButtonToRedirect("Orange_LevelBall.png","alpha",9);
        ...
        this.LevelBox11button = new ClickedButtonToRedirect("Orange_LevelBall.png","alpha",11);
       ...
       // NumberButton for Even Button
        ...
        this.LevelBox2button = new ClickedButtonToRedirect("Orange_LevelBall.png","alpha",2);
        ...
        this.LevelBox4button = new ClickedButtonToRedirect("Orange_LevelBall.png","alpha",4);
        ...
        this.LevelBox6button = new ClickedButtonToRedirect("Orange_LevelBall.png","alpha",6);
        ...
        this.LevelBox8button = new ClickedButtonToRedirect("Orange_LevelBall.png","alpha",8);
        ...
        this.LevelBox10button = new ClickedButtonToRedirect("Orange_LevelBall.png","alpha",10);
        ...
        this.LevelBox12button = new ClickedButtonToRedirect("Orange_LevelBall.png","alpha",12);
...
var AlphabetsMenuScene = cc.Scene.extend({
    onEnter:function () {
        this._super();
        
        var alphabetsScreenMenu = new AlphabetsMenu();
        this.addChild(alphabetsScreenMenu);
    }
});