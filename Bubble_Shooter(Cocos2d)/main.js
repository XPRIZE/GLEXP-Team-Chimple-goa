...
//    else
//    {
//             cc.view.setRealPixelResolution(800, 1280, cc.ResolutionPolicy.SHOW_ALL);
...
//    cc.LoaderScene.preload(All_resources, function () {
//     //    cc.director.setContentScaleFactor(2.87);
...
cc.game.onStart = function(){
    ...
    cc.view.setDesignResolutionSize(1800,2560, cc.ResolutionPolicy.SHOW_ALL);
    ...
    //load resources
    cc.LoaderScene.preload(All_resources, function () {
        cc.spriteFrameCache.addSpriteFrames(res.ObjectAllImage_plist);
        cc.spriteFrameCache.addSpriteFrames(res.Background2_plist);
        cc.spriteFrameCache.addSpriteFrames(res.Background1_plist);
        cc.spriteFrameCache.addSpriteFrames(res.Category_plist);
