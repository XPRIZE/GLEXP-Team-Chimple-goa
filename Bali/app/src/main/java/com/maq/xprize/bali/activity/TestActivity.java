...
import com.maq.xprize.bali.service.LessonService;
...
public class TestActivity extends AppCompatActivity {
    ...
    public void sendMessage(View view) {
        ...
        ComponentName componentName = new ComponentName("com.maq.xprize.chimple.hindi", "org.cocos2dx.cpp.AppActivity");
...
//                    Toast.makeText(getApplicationContext(), mcqs[1].answers[3], Toast.LENGTH_SHORT).show();
    ...
    protected void onStart() {
        ...
        // Bind to the service
        Intent intent = new Intent();
        intent.setComponent(new ComponentName("com.maq.xprize.bali",
                "com.maq.xprize.bali.service.LessonService"));
