...
var Level_5_Layer = cc.Layer.extend({
...
ctor : function () {
        ...
        // background sprite        
        this.Level_5_BG = new cc.Sprite(cc.spriteFrameCache.getSpriteFrame("bg/level4_bg.png"), this);
        this.Level_5_BG.attr({
           x : self.size.width/2,
           y : self.size.height/2,
           anchorX : .5,
           anchorY : .5 
        });
        this.addChild(this.Level_5_BG);
...
//           anchorX : .5,
       ...
       Level_2_mainFunction(this);
        ...
        self.position = [
{x:wid*19/100, y:hei*80.5/100}, {x:wid*39/100, y:hei*80/100}, {x:wid*58.5/100, y:hei*80.5/100}, {x:wid*79.5/100, y:hei*80/100}, 
{x:wid*17.5/100, y:hei*71/100}, {x:wid*39/100, y:hei*70.5/100}, {x:wid*59.3/100, y:hei*70/100}, {x:wid*79/100, y:hei*70.1/100},
{x:wid*19/100, y:hei*61/100}, {x:wid*38.5/100, y:hei*60.5/100}, {x:wid*59.3/100, y:hei*60/100}, {x:wid*78.5/100, y:hei*60.5/100}, 
{x:wid*20/100, y:hei*50/100}, {x:wid*37.5/100, y:hei*51/100}, {x:wid*58.5/100, y:hei*50.5/100}, {x:wid*79/100, y:hei*50/100},];
...
//            cc.eventManager.addListener(level5_sprite_click.clone(), v);
       }


            // this.Score_board after game finish       
            ...
            this.Ok_button.id = "Ok_button_Level_5";
            this.Ok_button.flag = 0;
            this.Ok_button.setVisible(false);
            
            // score on this.score_board
...
/*
    ...
    cc.eventManager.addListener(level5_sprite_click.clone(), this.Red_tile_shadow_1_1);
    cc.eventManager.addListener(level5_sprite_click.clone(), this.Red_tile_1_2);
    cc.eventManager.addListener(level5_sprite_click.clone(), this.Red_tile_1_3);

    cc.eventManager.addListener(level5_sprite_click.clone(), this.Cyan_tile_shadow_2_1);
    cc.eventManager.addListener(level5_sprite_click.clone(), this.Cyan_tile_2_2);

    cc.eventManager.addListener(level5_sprite_click.clone(), this.Green_tile_shadow_3_1);
    cc.eventManager.addListener(level5_sprite_click.clone(), this.Green_tile_3_2);
    cc.eventManager.addListener(level5_sprite_click.clone(), this.Green_tile_3_3);

    cc.eventManager.addListener(level5_sprite_click.clone(), this.Orange_tile_shadow_4_1);

    cc.eventManager.addListener(level5_sprite_click.clone(), this.Pink_tile_shadow_5_1);
    cc.eventManager.addListener(level5_sprite_click.clone(), this.Pink_tile_5_2);
    cc.eventManager.addListener(level5_sprite_click.clone(), this.Pink_tile_5_3);
    cc.eventManager.addListener(level5_sprite_click.clone(), this.Pink_tile_5_4);
    cc.eventManager.addListener(level5_sprite_click.clone(), this.Pink_tile_5_5);

    cc.eventManager.addListener(level5_sprite_click.clone(), this.Green_tile_shadow_6_1);
    cc.eventManager.addListener(level5_sprite_click.clone(), this.Green_tile_6_2);
    cc.eventManager.addListener(level5_sprite_click.clone(), this.Green_tile_6_3);

    cc.eventManager.addListener(level5_sprite_click.clone(), this.Cyan_tile_shadow_7_1);
    cc.eventManager.addListener(level5_sprite_click.clone(), this.Cyan_tile_7_2);

    cc.eventManager.addListener(level5_sprite_click.clone(), this.Red_tile_shadow_8_1);
    cc.eventManager.addListener(level5_sprite_click.clone(), this.Red_tile_8_2);

    cc.eventManager.addListener(level5_sprite_click.clone(), this.Orange_tile_shadow_9_1);
    cc.eventManager.addListener(level5_sprite_click.clone(), this.Orange_tile_9_2);
    cc.eventManager.addListener(level5_sprite_click.clone(), this.Orange_tile_9_3);
    
    cc.eventManager.addListener(level5_sprite_click.clone(), this.Red_tile_shadow_10_1);
    cc.eventManager.addListener(level5_sprite_click.clone(), this.Red_tile_10_2);
    cc.eventManager.addListener(level5_sprite_click.clone(), this.Red_tile_10_3);
    
    cc.eventManager.addListener(level5_sprite_click.clone(), this.Orange_tile_shadow_11_1);
    cc.eventManager.addListener(level5_sprite_click.clone(), this.Orange_tile_11_2);
    
    cc.eventManager.addListener(level5_sprite_click.clone(), this.Green_tile_shadow_12_1);
    cc.eventManager.addListener(level5_sprite_click.clone(), this.Green_tile_12_2);
    cc.eventManager.addListener(level5_sprite_click.clone(), this.Green_tile_12_3);

    cc.eventManager.addListener(level5_sprite_click.clone(), this.Cyan_tile_shadow_13_1)
    
    cc.eventManager.addListener(level5_sprite_click.clone(), this.Orange_tile_shadow_14_1);
    cc.eventManager.addListener(level5_sprite_click.clone(), this.Orange_tile_14_2);
    cc.eventManager.addListener(level5_sprite_click.clone(), this.Orange_tile_14_3);
    cc.eventManager.addListener(level5_sprite_click.clone(), this.Orange_tile_14_4);
    cc.eventManager.addListener(level5_sprite_click.clone(), this.Orange_tile_14_5);
    
    cc.eventManager.addListener(level5_sprite_click.clone(), this.Orange_tile_shadow_15_1);
    cc.eventManager.addListener(level5_sprite_click.clone(), this.Orange_tile_15_2);
    cc.eventManager.addListener(level5_sprite_click.clone(), this.Orange_tile_15_3);
    
    cc.eventManager.addListener(level5_sprite_click.clone(), this.Green_tile_shadow_16_1);
    cc.eventManager.addListener(level5_sprite_click.clone(), this.Green_tile_16_2);
    
    cc.eventManager.addListener(level5_sprite_click.clone(), this.Hint_Button);
    cc.eventManager.addListener(level5_sprite_click.clone(), this.Correct_Button);
    cc.eventManager.addListener(level5_sprite_click.clone(), this.Wrong_Button);
    cc.eventManager.addListener(level5_sprite_click.clone(), this.Home);    
    cc.eventManager.addListener(level5_sprite_click.clone(), Ok_button);    
*/    }
});

/*
var level5_sprite_click = cc.EventListener.create({event: cc.EventListener.TOUCH_ONE_BY_ONE, swallowTouches: true,
...
var Level_5_Scene = cc.Scene.extend({
    onEnter : function(){
    this._super();
    var layer = new Level_5_Layer();
    this.addChild(layer);
    }
});

/*
function Level_5_mainFunction()
{
    vowelArray = [];
    consonantArray = [];
    ...
    if(chars.length<1)
    {
        chars = Level_5_random_char(vowelArray, consonantArray);
    }
    else
    {
        ...
        var tempchar = this.Level_5_random_char(vowelArray, consonantArray);
        ...
        for(var i = 0; i<tempchar.length; i++)
        {
            ...
            console.log(clickLetter[ind].id);
            ...
            v = new eventListenerClass("res/"+v+".png");
            v.attr({
                  x : position[ind].x,
                  y : position[ind].y,
                  anchorX : .5,
    ...
    for(var vv = 0; vv<chars.length; vv++)
    {
        ...
        if(result==0)
        {
            var remaining_tiles = item_1.length + item_2.length + item_3.length + item_4.length + item_5.length + item_6.length + item_7.length + item_8.length + item_9.length + item_10.length + item_11.length + item_12.length + item_13.length + item_14.length + item_15.length + item_16.length;
...
function Level_5_random_char(v,c)
{
