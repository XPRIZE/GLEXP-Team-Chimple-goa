    ...
    var J = {
        ...
        preload: function () {
            ...
            this.rightPath = jPath;
            this.wrongPath = rPath;
            
            this.bgLetter = jLetter;
            ...
            for(var i=0;i<10;i++){
                ...
                this.load.image(jCollection[i].trans, this.rightPath + jCollection[i].trans + imageExtension);
                this.load.image(jCollection[i].name,this.rightPath + jCollection[i].name + imageExtension);
            ...
            for(var i=0;i<10;i++){
                ...
                this.load.image(rCollection[i].trans, this.wrongPath + rCollection[i].trans + imageExtension);  
                this.load.image(rCollection[i].name, this.wrongPath + rCollection[i].name + imageExtension);
            }
        ...
        create: function () {
            ...
            */
            ...
            shadow = game.add.sprite(gameMinWidth + 820, gameMinHeight + 480, "shadow");
        ...
        randomizeObjects: function() {
            ...
            this.rightTrans[0] = game.add.sprite(objectsPosition[randomPositionArray[0]].x,objectsPosition[randomPositionArray[0]].y, jCollection[randomObjectArray[0]].trans);
            this.rightTrans[0].anchor.setTo(spriteAnchorX, spriteAnchorY);
            this.rightTrans[0].scale.setTo(spriteScaleX, spriteScaleY);
          
            
            this.rightTrans[1] = game.add.sprite(objectsPosition[randomPositionArray[1]].x,objectsPosition[randomPositionArray[1]].y, jCollection[randomObjectArray[1]].trans);
            this.rightTrans[1].anchor.setTo(spriteAnchorX, spriteAnchorY);
            this.rightTrans[1].scale.setTo(spriteScaleX, spriteScaleY);
          
            
            this.rightTrans[2] = game.add.sprite(objectsPosition[randomPositionArray[2]].x,objectsPosition[randomPositionArray[2]].y, jCollection[randomObjectArray[2]].trans);
            this.rightTrans[2].anchor.setTo(spriteAnchorX, spriteAnchorY);
            this.rightTrans[2].scale.setTo(spriteScaleX, spriteScaleY);
          
            
            this.rightTrans[3] = game.add.sprite(objectsPosition[randomPositionArray[3]].x,objectsPosition[randomPositionArray[3]].y, jCollection[randomObjectArray[3]].trans);
            this.rightTrans[3].anchor.setTo(spriteAnchorX, spriteAnchorY);
            this.rightTrans[3].scale.setTo(spriteScaleX, spriteScaleY);
          
            
            this.rightTrans[4] = game.add.sprite(objectsPosition[randomPositionArray[4]].x,objectsPosition[randomPositionArray[4]].y, jCollection[randomObjectArray[4]].trans);
            ...
            this.rightObjects[0] = game.add.sprite(objectsPosition[randomPositionArray[0]].x,objectsPosition[randomPositionArray[0]].y, jCollection[randomObjectArray[0]].name);
            ...
            this.rightObjects[0].name = jCollection[randomObjectArray[0]].name;
            this.rightObjects[0].trans = jCollection[randomObjectArray[0]].trans;
            ...
            this.rightObjects[1] = game.add.sprite(objectsPosition[randomPositionArray[1]].x,objectsPosition[randomPositionArray[1]].y, jCollection[randomObjectArray[1]].name);
            ...
            this.rightObjects[1].name = jCollection[randomObjectArray[1]].name;
            this.rightObjects[1].trans = jCollection[randomObjectArray[1]].trans;
            ...
            this.rightObjects[2] = game.add.sprite(objectsPosition[randomPositionArray[2]].x,objectsPosition[randomPositionArray[2]].y, jCollection[randomObjectArray[2]].name);
            ...
            this.rightObjects[2].name = jCollection[randomObjectArray[2]].name;
            this.rightObjects[2].trans = jCollection[randomObjectArray[2]].trans;
            ...
            this.rightObjects[3] = game.add.sprite(objectsPosition[randomPositionArray[3]].x,objectsPosition[randomPositionArray[3]].y, jCollection[randomObjectArray[3]].name);
            ...
            this.rightObjects[3].name = jCollection[randomObjectArray[3]].name;
            this.rightObjects[3].trans = jCollection[randomObjectArray[3]].trans;
            ...
            this.rightObjects[4] = game.add.sprite(objectsPosition[randomPositionArray[4]].x,objectsPosition[randomPositionArray[4]].y, jCollection[randomObjectArray[4]].name);
            ...
            this.rightObjects[4].name = jCollection[randomObjectArray[4]].name;
            this.rightObjects[4].trans = jCollection[randomObjectArray[4]].trans;
            ...
            this.wrongTrans[5] = game.add.sprite(objectsPosition[randomPositionArray[5]].x,objectsPosition[randomPositionArray[5]].y, rCollection[randomObjectArray[0]].trans);
            this.wrongTrans[5].anchor.setTo(spriteAnchorX, spriteAnchorY);
            this.wrongTrans[5].scale.setTo(spriteScaleX, spriteScaleY);
            
            
            this.wrongTrans[6] = game.add.sprite(objectsPosition[randomPositionArray[6]].x,objectsPosition[randomPositionArray[6]].y, rCollection[randomObjectArray[1]].trans);
            this.wrongTrans[6].anchor.setTo(spriteAnchorX, spriteAnchorY);
            this.wrongTrans[6].scale.setTo(spriteScaleX, spriteScaleY);
            
            
            this.wrongTrans[7] = game.add.sprite(objectsPosition[randomPositionArray[7]].x,objectsPosition[randomPositionArray[7]].y, rCollection[randomObjectArray[2]].trans);
            this.wrongTrans[7].anchor.setTo(spriteAnchorX, spriteAnchorY);
            this.wrongTrans[7].scale.setTo(spriteScaleX, spriteScaleY);
            
            
            this.wrongTrans[8] = game.add.sprite(objectsPosition[randomPositionArray[8]].x,objectsPosition[randomPositionArray[8]].y, rCollection[randomObjectArray[3]].trans);
            this.wrongTrans[8].anchor.setTo(spriteAnchorX, spriteAnchorY);
            this.wrongTrans[8].scale.setTo(spriteScaleX, spriteScaleY);
            
            
            this.wrongTrans[9] = game.add.sprite(objectsPosition[randomPositionArray[9]].x,objectsPosition[randomPositionArray[9]].y, rCollection[randomObjectArray[4]].trans);
            ...
            this.wrongObjects[5] =  game.add.sprite(objectsPosition[randomPositionArray[5]].x, objectsPosition[randomPositionArray[5]].y, rCollection[randomObjectArray[0]].name);
            ...
            this.wrongObjects[5].name = rCollection[randomObjectArray[0]].name;
            this.wrongObjects[5].trans = rCollection[randomObjectArray[0]].trans;
            ...
            this.wrongObjects[6] =  game.add.sprite(objectsPosition[randomPositionArray[6]].x, objectsPosition[randomPositionArray[6]].y, rCollection[randomObjectArray[1]].name);
            ...
            this.wrongObjects[6].name = rCollection[randomObjectArray[1]].name;
            this.wrongObjects[6].trans = rCollection[randomObjectArray[1]].trans;
            ...
            this.wrongObjects[7] =  game.add.sprite(objectsPosition[randomPositionArray[7]].x, objectsPosition[randomPositionArray[7]].y, rCollection[randomObjectArray[2]].name);
            ...
            this.wrongObjects[7].name = rCollection[randomObjectArray[2]].name;
            this.wrongObjects[7].trans = rCollection[randomObjectArray[2]].trans;
            ...
            this.wrongObjects[8] =  game.add.sprite(objectsPosition[randomPositionArray[8]].x, objectsPosition[randomPositionArray[8]].y, rCollection[randomObjectArray[3]].name);
            ...
            this.wrongObjects[8].name = rCollection[randomObjectArray[3]].name;
            this.wrongObjects[8].trans = rCollection[randomObjectArray[3]].trans;
            ...
            this.wrongObjects[9] =  game.add.sprite(objectsPosition[randomPositionArray[9]].x, objectsPosition[randomPositionArray[9]].y, rCollection[randomObjectArray[4]].name);
            ...
            this.wrongObjects[9].name = rCollection[randomObjectArray[4]].name;
            this.wrongObjects[9].trans = rCollection[randomObjectArray[4]].trans;
