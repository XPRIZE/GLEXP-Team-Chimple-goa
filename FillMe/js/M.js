    ...
    var M = {
        ...
        preload: function () {
            ...
            for(var i=0;i<10;i++){
                ...
                this.load.image(oCollection[i].trans, this.wrongPath + oCollection[i].trans + imageExtension);  
                this.load.image(oCollection[i].name, this.wrongPath + oCollection[i].name + imageExtension);
            }
        ...
        create: function () {
            ...
            shadow = game.add.image(gameMinWidth+830, gameMinHeight+500, "shadow");
        ...
        randomizeObjects: function() {
            ...
            this.wrongTrans[5] = game.add.sprite(objectsPosition[randomPositionArray[5]].x,objectsPosition[randomPositionArray[5]].y, oCollection[randomObjectArray[0]].trans);
            this.wrongTrans[5].anchor.setTo(spriteAnchorX, spriteAnchorY);
            this.wrongTrans[5].scale.setTo(spriteScaleX, spriteScaleY);
            
            
            this.wrongTrans[6] = game.add.sprite(objectsPosition[randomPositionArray[6]].x,objectsPosition[randomPositionArray[6]].y, oCollection[randomObjectArray[1]].trans);
            this.wrongTrans[6].anchor.setTo(spriteAnchorX, spriteAnchorY);
            this.wrongTrans[6].scale.setTo(spriteScaleX, spriteScaleY);
            
            
            this.wrongTrans[7] = game.add.sprite(objectsPosition[randomPositionArray[7]].x,objectsPosition[randomPositionArray[7]].y, oCollection[randomObjectArray[2]].trans);
            this.wrongTrans[7].anchor.setTo(spriteAnchorX, spriteAnchorY);
            this.wrongTrans[7].scale.setTo(spriteScaleX, spriteScaleY);
            
            
            this.wrongTrans[8] = game.add.sprite(objectsPosition[randomPositionArray[8]].x,objectsPosition[randomPositionArray[8]].y, oCollection[randomObjectArray[3]].trans);
            this.wrongTrans[8].anchor.setTo(spriteAnchorX, spriteAnchorY);
            this.wrongTrans[8].scale.setTo(spriteScaleX, spriteScaleY);
            
            
            this.wrongTrans[9] = game.add.sprite(objectsPosition[randomPositionArray[9]].x,objectsPosition[randomPositionArray[9]].y, oCollection[randomObjectArray[4]].trans);
            ...
            this.wrongObjects[5] =  game.add.sprite(objectsPosition[randomPositionArray[5]].x, objectsPosition[randomPositionArray[5]].y, oCollection[randomObjectArray[0]].name);
            ...
            this.wrongObjects[5].name = oCollection[randomObjectArray[0]].name;
            this.wrongObjects[5].trans = oCollection[randomObjectArray[0]].trans;
            ...
            this.wrongObjects[6].name = oCollection[randomObjectArray[1]].name;
            this.wrongObjects[6].trans = oCollection[randomObjectArray[1]].trans;
            ...
            this.wrongObjects[7].name = oCollection[randomObjectArray[2]].name;
            this.wrongObjects[7].trans = oCollection[randomObjectArray[2]].trans;
            ...
            this.wrongObjects[8].name = oCollection[randomObjectArray[3]].name;
            this.wrongObjects[8].trans = oCollection[randomObjectArray[3]].trans;
            ...
            this.wrongObjects[9].name = oCollection[randomObjectArray[4]].name;
            this.wrongObjects[9].trans = oCollection[randomObjectArray[4]].trans;
