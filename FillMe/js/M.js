    ...
    var M = {
        ...
        preload: function () {
            ...
            this.rightPath = mPath;
            this.wrongPath = nPath;
            
            this.bgLetter = mLetter;
            ...
            for(var i=0;i<10;i++){
                ...
                this.load.image(mCollection[i].trans, this.rightPath + mCollection[i].trans + imageExtension);
                this.load.image(mCollection[i].name,this.rightPath + mCollection[i].name + imageExtension);
            ...
            for(var i=0;i<10;i++){
                ...
                this.load.image(nCollection[i].trans, this.wrongPath + nCollection[i].trans + imageExtension);  
                this.load.image(nCollection[i].name, this.wrongPath + nCollection[i].name + imageExtension);
            }
        ...
        randomizeObjects: function() {
            ...
            this.rightTrans[0] = game.add.sprite(objectsPosition[randomPositionArray[0]].x,objectsPosition[randomPositionArray[0]].y, mCollection[randomObjectArray[0]].trans);
            this.rightTrans[0].anchor.setTo(spriteAnchorX, spriteAnchorY);
            this.rightTrans[0].scale.setTo(scale.x/4, scale.y/4);
          
            
            this.rightTrans[1] = game.add.sprite(objectsPosition[randomPositionArray[1]].x,objectsPosition[randomPositionArray[1]].y, mCollection[randomObjectArray[1]].trans);
            this.rightTrans[1].anchor.setTo(spriteAnchorX, spriteAnchorY);
            this.rightTrans[1].scale.setTo(scale.x/4, scale.y/4);
          
            
            this.rightTrans[2] = game.add.sprite(objectsPosition[randomPositionArray[2]].x,objectsPosition[randomPositionArray[2]].y, mCollection[randomObjectArray[2]].trans);
            this.rightTrans[2].anchor.setTo(spriteAnchorX, spriteAnchorY);
            this.rightTrans[2].scale.setTo(scale.x/4, scale.y/4);
          
            
            this.rightTrans[3] = game.add.sprite(objectsPosition[randomPositionArray[3]].x,objectsPosition[randomPositionArray[3]].y, mCollection[randomObjectArray[3]].trans);
            this.rightTrans[3].anchor.setTo(spriteAnchorX, spriteAnchorY);
            this.rightTrans[3].scale.setTo(scale.x/4, scale.y/4);
          
            
            this.rightTrans[4] = game.add.sprite(objectsPosition[randomPositionArray[4]].x,objectsPosition[randomPositionArray[4]].y, mCollection[randomObjectArray[4]].trans);
            ...
            this.rightObjects[0] = game.add.sprite(objectsPosition[randomPositionArray[0]].x,objectsPosition[randomPositionArray[0]].y, mCollection[randomObjectArray[0]].name);
            ...
            this.rightObjects[0].name = mCollection[randomObjectArray[0]].name;
            this.rightObjects[0].trans = mCollection[randomObjectArray[0]].trans;
            ...
            this.rightObjects[1] = game.add.sprite(objectsPosition[randomPositionArray[1]].x,objectsPosition[randomPositionArray[1]].y, mCollection[randomObjectArray[1]].name);
            ...
            this.rightObjects[1].name = mCollection[randomObjectArray[1]].name;
            this.rightObjects[1].trans = mCollection[randomObjectArray[1]].trans;
            ...
            this.rightObjects[2] = game.add.sprite(objectsPosition[randomPositionArray[2]].x,objectsPosition[randomPositionArray[2]].y, mCollection[randomObjectArray[2]].name);
            ...
            this.rightObjects[2].name = mCollection[randomObjectArray[2]].name;
            this.rightObjects[2].trans = mCollection[randomObjectArray[2]].trans;
            ...
            this.rightObjects[3] = game.add.sprite(objectsPosition[randomPositionArray[3]].x,objectsPosition[randomPositionArray[3]].y, mCollection[randomObjectArray[3]].name);
            ...
            this.rightObjects[3].name = mCollection[randomObjectArray[3]].name;
            this.rightObjects[3].trans = mCollection[randomObjectArray[3]].trans;
            ...
            this.rightObjects[4] = game.add.sprite(objectsPosition[randomPositionArray[4]].x,objectsPosition[randomPositionArray[4]].y, mCollection[randomObjectArray[4]].name);
            ...
            this.rightObjects[4].name = mCollection[randomObjectArray[4]].name;
            this.rightObjects[4].trans = mCollection[randomObjectArray[4]].trans;
            ...
            this.wrongTrans[5] = game.add.sprite(objectsPosition[randomPositionArray[5]].x,objectsPosition[randomPositionArray[5]].y, nCollection[randomObjectArray[0]].trans);
            this.wrongTrans[5].anchor.setTo(spriteAnchorX, spriteAnchorY);
            this.wrongTrans[5].scale.setTo(scale.x/4, scale.y/4);
            
            
            this.wrongTrans[6] = game.add.sprite(objectsPosition[randomPositionArray[6]].x,objectsPosition[randomPositionArray[6]].y, nCollection[randomObjectArray[1]].trans);
            this.wrongTrans[6].anchor.setTo(spriteAnchorX, spriteAnchorY);
            this.wrongTrans[6].scale.setTo(scale.x/4, scale.y/4);
            
            
            this.wrongTrans[7] = game.add.sprite(objectsPosition[randomPositionArray[7]].x,objectsPosition[randomPositionArray[7]].y, nCollection[randomObjectArray[2]].trans);
            this.wrongTrans[7].anchor.setTo(spriteAnchorX, spriteAnchorY);
            this.wrongTrans[7].scale.setTo(scale.x/4, scale.y/4);
            
            
            this.wrongTrans[8] = game.add.sprite(objectsPosition[randomPositionArray[8]].x,objectsPosition[randomPositionArray[8]].y, nCollection[randomObjectArray[3]].trans);
            this.wrongTrans[8].anchor.setTo(spriteAnchorX, spriteAnchorY);
            this.wrongTrans[8].scale.setTo(scale.x/4, scale.y/4);
            
            
            this.wrongTrans[9] = game.add.sprite(objectsPosition[randomPositionArray[9]].x,objectsPosition[randomPositionArray[9]].y, nCollection[randomObjectArray[4]].trans);
            ...
            this.wrongObjects[5] =  game.add.sprite(objectsPosition[randomPositionArray[5]].x, objectsPosition[randomPositionArray[5]].y, nCollection[randomObjectArray[0]].name);
            ...
            this.wrongObjects[5].name = nCollection[randomObjectArray[0]].name;
            this.wrongObjects[5].trans = nCollection[randomObjectArray[0]].trans;
            ...
            this.wrongObjects[6] =  game.add.sprite(objectsPosition[randomPositionArray[6]].x, objectsPosition[randomPositionArray[6]].y, nCollection[randomObjectArray[1]].name);
            ...
            this.wrongObjects[6].name = nCollection[randomObjectArray[1]].name;
            this.wrongObjects[6].trans = nCollection[randomObjectArray[1]].trans;
            ...
            this.wrongObjects[7] =  game.add.sprite(objectsPosition[randomPositionArray[7]].x, objectsPosition[randomPositionArray[7]].y, nCollection[randomObjectArray[2]].name);
            ...
            this.wrongObjects[7].name = nCollection[randomObjectArray[2]].name;
            this.wrongObjects[7].trans = nCollection[randomObjectArray[2]].trans;
            ...
            this.wrongObjects[8] =  game.add.sprite(objectsPosition[randomPositionArray[8]].x, objectsPosition[randomPositionArray[8]].y, nCollection[randomObjectArray[3]].name);
            ...
            this.wrongObjects[8].name = nCollection[randomObjectArray[3]].name;
            this.wrongObjects[8].trans = nCollection[randomObjectArray[3]].trans;
            ...
            this.wrongObjects[9] =  game.add.sprite(objectsPosition[randomPositionArray[9]].x, objectsPosition[randomPositionArray[9]].y, nCollection[randomObjectArray[4]].name);
            ...
            this.wrongObjects[9].name = nCollection[randomObjectArray[4]].name;
            this.wrongObjects[9].trans = nCollection[randomObjectArray[4]].trans;
