    ...
    var A = {
        ...
        preload: function () {
            ...
            for(var i=0;i<10;i++){
                ...
                this.load.image(aCollection[i].trans, aPath + aCollection[i].trans + imageExtension);
                this.load.image(aCollection[i].name,aPath + aCollection[i].name + imageExtension);
            ...
            this.load.image(bg, aPath +  bg + imageExtension);
            this.load.image(aLetter,aPath +  aLetter + imageExtension);
            this.load.image(bButton,aPath +  bButton + imageExtension);
            ...
            for(var i=0;i<10;i++){
                ...
                this.load.image(bCollection[i].trans, bPath + bCollection[i].trans + imageExtension);  
                this.load.image(bCollection[i].name, bPath + bCollection[i].name + imageExtension);
            }
        ...
        create: function () {
            ...
            //Adding progess bar
            timeBar = game.add.image(timeBarPosition.x  , timeBarPosition.y, timeBar);
            ...
            //Adding images 
            bg = game.add.image(gameMinWidth, gameMinHeight,  bg);
                
            
            //Main letter 
            Letter = game.add.sprite(gameMinWidth, gameMinHeight, aLetter);
        ...
        randomizeObjects: function() {
            ...
            this.wrongObjects[5] =  game.add.sprite(objectsPosition[randomPositionArray[5]].x, objectsPosition[randomPositionArray[5]].y, bCollection[randomObjectArray[0]].name);
            ...
            this.wrongObjects[6] =  game.add.sprite(objectsPosition[randomPositionArray[6]].x, objectsPosition[randomPositionArray[6]].y, bCollection[randomObjectArray[1]].name);
            ...
            this.wrongObjects[7] =  game.add.sprite(objectsPosition[randomPositionArray[7]].x, objectsPosition[randomPositionArray[7]].y, bCollection[randomObjectArray[2]].name);
            ...
            this.wrongObjects[8] =  game.add.sprite(objectsPosition[randomPositionArray[8]].x, objectsPosition[randomPositionArray[8]].y, bCollection[randomObjectArray[3]].name);
            ...
            this.wrongObjects[9] =  game.add.sprite(objectsPosition[randomPositionArray[9]].x, objectsPosition[randomPositionArray[9]].y, bCollection[randomObjectArray[4]].name);
...
object.anchor.setTo(paintObjectAnchorX, paintObjectAnchorY);stickSound.play();                        
    ...
    this.randomizeObjects();
      ...
      killAllSprites: function(){
            ...
            for(var i=0; i<5; i++){ this.rightObjects[i].kill();}
            
            for(var i=5; i<10; i++){ this.wrongObjects[i].kill();}
            
            for(var i=0; i<10; i++){ this.colorBoxes[i].kill();}
          
            for(var i=0; i<5; i++){ this.rightTrans[i].kill();}
          
            for(var i=5; i<10; i++){ this.wrongTrans[i].kill();}
        ...
        if(askForNextLevel == 1){
            ...
            game.bButton.events.onInputDown.add(onDownNext, this);
            function onDownNext() {
