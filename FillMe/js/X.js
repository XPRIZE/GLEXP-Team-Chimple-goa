    ...
    var X = {
        ...
        preload: function () {
            ...
            this.rightPath = xPath;
            this.wrongPath = cPath;
            
            this.bgLetter = xLetter;
            ...
            for(var i=0;i<10;i++){
                ...
                this.load.image(xCollection[i].trans, this.rightPath + xCollection[i].trans + imageExtension);
                this.load.image(xCollection[i].name,this.rightPath + xCollection[i].name + imageExtension);
            ...
            for(var i=0;i<10;i++){
                ...
                this.load.image(cCollection[i].trans, this.wrongPath + cCollection[i].trans + imageExtension);  
                this.load.image(cCollection[i].name, this.wrongPath + cCollection[i].name + imageExtension);
            }
        ...
        create: function () {
            ...
            shadow = game.add.sprite(gameMinWidth + 740, gameMinHeight + 490, "shadow");
        ...
        randomizeObjects: function() {
            ...
            this.rightTrans[0] = game.add.sprite(objectsPosition[randomPositionArray[0]].x,objectsPosition[randomPositionArray[0]].y, xCollection[randomObjectArray[0]].trans);
            this.rightTrans[0].anchor.setTo(spriteAnchorX, spriteAnchorY);
            this.rightTrans[0].scale.setTo(spriteScaleX, spriteScaleY);
          
            
            this.rightTrans[1] = game.add.sprite(objectsPosition[randomPositionArray[1]].x,objectsPosition[randomPositionArray[1]].y, xCollection[randomObjectArray[1]].trans);
            this.rightTrans[1].anchor.setTo(spriteAnchorX, spriteAnchorY);
            this.rightTrans[1].scale.setTo(spriteScaleX, spriteScaleY);
          
            
            this.rightTrans[2] = game.add.sprite(objectsPosition[randomPositionArray[2]].x,objectsPosition[randomPositionArray[2]].y, xCollection[randomObjectArray[2]].trans);
            this.rightTrans[2].anchor.setTo(spriteAnchorX, spriteAnchorY);
            this.rightTrans[2].scale.setTo(spriteScaleX, spriteScaleY);
          
            
            this.rightTrans[3] = game.add.sprite(objectsPosition[randomPositionArray[3]].x,objectsPosition[randomPositionArray[3]].y, xCollection[randomObjectArray[3]].trans);
            this.rightTrans[3].anchor.setTo(spriteAnchorX, spriteAnchorY);
            this.rightTrans[3].scale.setTo(spriteScaleX, spriteScaleY);
          
            
            this.rightTrans[4] = game.add.sprite(objectsPosition[randomPositionArray[4]].x,objectsPosition[randomPositionArray[4]].y, xCollection[randomObjectArray[4]].trans);
            ...
            this.rightObjects[0] = game.add.sprite(objectsPosition[randomPositionArray[0]].x,objectsPosition[randomPositionArray[0]].y, xCollection[randomObjectArray[0]].name);
            ...
            this.rightObjects[0].name = xCollection[randomObjectArray[0]].name;
            this.rightObjects[0].trans = xCollection[randomObjectArray[0]].trans;
            ...
            this.rightObjects[1] = game.add.sprite(objectsPosition[randomPositionArray[1]].x,objectsPosition[randomPositionArray[1]].y, xCollection[randomObjectArray[1]].name);
            ...
            this.rightObjects[1].name = xCollection[randomObjectArray[1]].name;
            this.rightObjects[1].trans = xCollection[randomObjectArray[1]].trans;
            ...
            this.rightObjects[2] = game.add.sprite(objectsPosition[randomPositionArray[2]].x,objectsPosition[randomPositionArray[2]].y, xCollection[randomObjectArray[2]].name);
            ...
            this.rightObjects[2].name = xCollection[randomObjectArray[2]].name;
            this.rightObjects[2].trans = xCollection[randomObjectArray[2]].trans;
            ...
            this.rightObjects[3] = game.add.sprite(objectsPosition[randomPositionArray[3]].x,objectsPosition[randomPositionArray[3]].y, xCollection[randomObjectArray[3]].name);
            ...
            this.rightObjects[3].name = xCollection[randomObjectArray[3]].name;
            this.rightObjects[3].trans = xCollection[randomObjectArray[3]].trans;
            ...
            this.rightObjects[4] = game.add.sprite(objectsPosition[randomPositionArray[4]].x,objectsPosition[randomPositionArray[4]].y, xCollection[randomObjectArray[4]].name);
            ...
            this.rightObjects[4].name = xCollection[randomObjectArray[4]].name;
            this.rightObjects[4].trans = xCollection[randomObjectArray[4]].trans;
            ...
            this.wrongTrans[5] = game.add.sprite(objectsPosition[randomPositionArray[5]].x,objectsPosition[randomPositionArray[5]].y, cCollection[randomObjectArray[0]].trans);
            this.wrongTrans[5].anchor.setTo(spriteAnchorX, spriteAnchorY);
            this.wrongTrans[5].scale.setTo(spriteScaleX, spriteScaleY);
            
            
            this.wrongTrans[6] = game.add.sprite(objectsPosition[randomPositionArray[6]].x,objectsPosition[randomPositionArray[6]].y, cCollection[randomObjectArray[1]].trans);
            this.wrongTrans[6].anchor.setTo(spriteAnchorX, spriteAnchorY);
            this.wrongTrans[6].scale.setTo(spriteScaleX, spriteScaleY);
            
            
            this.wrongTrans[7] = game.add.sprite(objectsPosition[randomPositionArray[7]].x,objectsPosition[randomPositionArray[7]].y, cCollection[randomObjectArray[2]].trans);
            this.wrongTrans[7].anchor.setTo(spriteAnchorX, spriteAnchorY);
            this.wrongTrans[7].scale.setTo(spriteScaleX, spriteScaleY);
            
            
            this.wrongTrans[8] = game.add.sprite(objectsPosition[randomPositionArray[8]].x,objectsPosition[randomPositionArray[8]].y, cCollection[randomObjectArray[3]].trans);
            this.wrongTrans[8].anchor.setTo(spriteAnchorX, spriteAnchorY);
            this.wrongTrans[8].scale.setTo(spriteScaleX, spriteScaleY);
            
            
            this.wrongTrans[9] = game.add.sprite(objectsPosition[randomPositionArray[9]].x,objectsPosition[randomPositionArray[9]].y, cCollection[randomObjectArray[4]].trans);
            ...
            this.wrongObjects[5] =  game.add.sprite(objectsPosition[randomPositionArray[5]].x, objectsPosition[randomPositionArray[5]].y, cCollection[randomObjectArray[0]].name);
            ...
            this.wrongObjects[5].name = cCollection[randomObjectArray[0]].name;
            this.wrongObjects[5].trans = cCollection[randomObjectArray[0]].trans;
            ...
            this.wrongObjects[6] =  game.add.sprite(objectsPosition[randomPositionArray[6]].x, objectsPosition[randomPositionArray[6]].y, cCollection[randomObjectArray[1]].name);
            ...
            this.wrongObjects[6].name = cCollection[randomObjectArray[1]].name;
            this.wrongObjects[6].trans = cCollection[randomObjectArray[1]].trans;
            ...
            this.wrongObjects[7] =  game.add.sprite(objectsPosition[randomPositionArray[7]].x, objectsPosition[randomPositionArray[7]].y, cCollection[randomObjectArray[2]].name);
            ...
            this.wrongObjects[7].name = cCollection[randomObjectArray[2]].name;
            this.wrongObjects[7].trans = cCollection[randomObjectArray[2]].trans;
            ...
            this.wrongObjects[8] =  game.add.sprite(objectsPosition[randomPositionArray[8]].x, objectsPosition[randomPositionArray[8]].y, cCollection[randomObjectArray[3]].name);
            ...
            this.wrongObjects[8].name = cCollection[randomObjectArray[3]].name;
            this.wrongObjects[8].trans = cCollection[randomObjectArray[3]].trans;
            ...
            this.wrongObjects[9] =  game.add.sprite(objectsPosition[randomPositionArray[9]].x, objectsPosition[randomPositionArray[9]].y, cCollection[randomObjectArray[4]].name);
            ...
            this.wrongObjects[9].name = cCollection[randomObjectArray[4]].name;
            this.wrongObjects[9].trans = cCollection[randomObjectArray[4]].trans;
