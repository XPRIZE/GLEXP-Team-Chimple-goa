    ...
    var I = {
        ...
        preload: function () {
            ...
            this.rightPath = iPath;
            this.wrongPath = sPath;
            
            this.bgLetter = iLetter;
            ...
            for(var i=0;i<10;i++){
                ...
                this.load.image(iCollection[i].trans, this.rightPath + iCollection[i].trans + imageExtension);
                this.load.image(iCollection[i].name,this.rightPath + iCollection[i].name + imageExtension);
            ...
            for(var i=0;i<10;i++){
                ...
                this.load.image(sCollection[i].trans, this.wrongPath + sCollection[i].trans + imageExtension);  
                this.load.image(sCollection[i].name, this.wrongPath + sCollection[i].name + imageExtension);
            }
        ...
        create: function () {
            ...
            */
            ...
            shadow = game.add.sprite(gameMinWidth + 820, gameMinHeight + 505, "shadow");
        ...
        randomizeObjects: function() {
            ...
            this.rightTrans[0] = game.add.sprite(objectsPosition[randomPositionArray[0]].x,objectsPosition[randomPositionArray[0]].y, iCollection[randomObjectArray[0]].trans);
            this.rightTrans[0].anchor.setTo(spriteAnchorX, spriteAnchorY);
            this.rightTrans[0].scale.setTo(spriteScaleX, spriteScaleY);
          
            
            this.rightTrans[1] = game.add.sprite(objectsPosition[randomPositionArray[1]].x,objectsPosition[randomPositionArray[1]].y, iCollection[randomObjectArray[1]].trans);
            this.rightTrans[1].anchor.setTo(spriteAnchorX, spriteAnchorY);
            this.rightTrans[1].scale.setTo(spriteScaleX, spriteScaleY);
          
            
            this.rightTrans[2] = game.add.sprite(objectsPosition[randomPositionArray[2]].x,objectsPosition[randomPositionArray[2]].y, iCollection[randomObjectArray[2]].trans);
            this.rightTrans[2].anchor.setTo(spriteAnchorX, spriteAnchorY);
            this.rightTrans[2].scale.setTo(spriteScaleX, spriteScaleY);
          
            
            this.rightTrans[3] = game.add.sprite(objectsPosition[randomPositionArray[3]].x,objectsPosition[randomPositionArray[3]].y, iCollection[randomObjectArray[3]].trans);
            this.rightTrans[3].anchor.setTo(spriteAnchorX, spriteAnchorY);
            this.rightTrans[3].scale.setTo(spriteScaleX, spriteScaleY);
          
            
            this.rightTrans[4] = game.add.sprite(objectsPosition[randomPositionArray[4]].x,objectsPosition[randomPositionArray[4]].y, iCollection[randomObjectArray[4]].trans);
            ...
            this.rightObjects[0] = game.add.sprite(objectsPosition[randomPositionArray[0]].x,objectsPosition[randomPositionArray[0]].y, iCollection[randomObjectArray[0]].name);
            ...
            this.rightObjects[0].name = iCollection[randomObjectArray[0]].name;
            this.rightObjects[0].trans = iCollection[randomObjectArray[0]].trans;
            ...
            this.rightObjects[1] = game.add.sprite(objectsPosition[randomPositionArray[1]].x,objectsPosition[randomPositionArray[1]].y, iCollection[randomObjectArray[1]].name);
            ...
            this.rightObjects[1].name = iCollection[randomObjectArray[1]].name;
            this.rightObjects[1].trans = iCollection[randomObjectArray[1]].trans;
            ...
            this.rightObjects[2] = game.add.sprite(objectsPosition[randomPositionArray[2]].x,objectsPosition[randomPositionArray[2]].y, iCollection[randomObjectArray[2]].name);
            ...
            this.rightObjects[2].name = iCollection[randomObjectArray[2]].name;
            this.rightObjects[2].trans = iCollection[randomObjectArray[2]].trans;
            ...
            this.rightObjects[3] = game.add.sprite(objectsPosition[randomPositionArray[3]].x,objectsPosition[randomPositionArray[3]].y, iCollection[randomObjectArray[3]].name);
            ...
            this.rightObjects[3].name = iCollection[randomObjectArray[3]].name;
            this.rightObjects[3].trans = iCollection[randomObjectArray[3]].trans;
            ...
            this.rightObjects[4] = game.add.sprite(objectsPosition[randomPositionArray[4]].x,objectsPosition[randomPositionArray[4]].y, iCollection[randomObjectArray[4]].name);
            ...
            this.rightObjects[4].name = iCollection[randomObjectArray[4]].name;
            this.rightObjects[4].trans = iCollection[randomObjectArray[4]].trans;
            ...
            this.wrongTrans[5] = game.add.sprite(objectsPosition[randomPositionArray[5]].x,objectsPosition[randomPositionArray[5]].y, sCollection[randomObjectArray[0]].trans);
            this.wrongTrans[5].anchor.setTo(spriteAnchorX, spriteAnchorY);
            this.wrongTrans[5].scale.setTo(spriteScaleX, spriteScaleY);
            
            
            this.wrongTrans[6] = game.add.sprite(objectsPosition[randomPositionArray[6]].x,objectsPosition[randomPositionArray[6]].y, sCollection[randomObjectArray[1]].trans);
            this.wrongTrans[6].anchor.setTo(spriteAnchorX, spriteAnchorY);
            this.wrongTrans[6].scale.setTo(spriteScaleX, spriteScaleY);
            
            
            this.wrongTrans[7] = game.add.sprite(objectsPosition[randomPositionArray[7]].x,objectsPosition[randomPositionArray[7]].y, sCollection[randomObjectArray[2]].trans);
            this.wrongTrans[7].anchor.setTo(spriteAnchorX, spriteAnchorY);
            this.wrongTrans[7].scale.setTo(spriteScaleX, spriteScaleY);
            
            
            this.wrongTrans[8] = game.add.sprite(objectsPosition[randomPositionArray[8]].x,objectsPosition[randomPositionArray[8]].y, sCollection[randomObjectArray[3]].trans);
            this.wrongTrans[8].anchor.setTo(spriteAnchorX, spriteAnchorY);
            this.wrongTrans[8].scale.setTo(spriteScaleX, spriteScaleY);
            
            
            this.wrongTrans[9] = game.add.sprite(objectsPosition[randomPositionArray[9]].x,objectsPosition[randomPositionArray[9]].y, sCollection[randomObjectArray[4]].trans);
            ...
            this.wrongObjects[5] =  game.add.sprite(objectsPosition[randomPositionArray[5]].x, objectsPosition[randomPositionArray[5]].y, sCollection[randomObjectArray[0]].name);
            ...
            this.wrongObjects[5].name = sCollection[randomObjectArray[0]].name;
            this.wrongObjects[5].trans = sCollection[randomObjectArray[0]].trans;
            ...
            this.wrongObjects[6] =  game.add.sprite(objectsPosition[randomPositionArray[6]].x, objectsPosition[randomPositionArray[6]].y, sCollection[randomObjectArray[1]].name);
            ...
            this.wrongObjects[6].name = sCollection[randomObjectArray[1]].name;
            this.wrongObjects[6].trans = sCollection[randomObjectArray[1]].trans;
            ...
            this.wrongObjects[7] =  game.add.sprite(objectsPosition[randomPositionArray[7]].x, objectsPosition[randomPositionArray[7]].y, sCollection[randomObjectArray[2]].name);
            ...
            this.wrongObjects[7].name = sCollection[randomObjectArray[2]].name;
            this.wrongObjects[7].trans = sCollection[randomObjectArray[2]].trans;
            ...
            this.wrongObjects[8] =  game.add.sprite(objectsPosition[randomPositionArray[8]].x, objectsPosition[randomPositionArray[8]].y, sCollection[randomObjectArray[3]].name);
            ...
            this.wrongObjects[8].name = sCollection[randomObjectArray[3]].name;
            this.wrongObjects[8].trans = sCollection[randomObjectArray[3]].trans;
            ...
            this.wrongObjects[9] =  game.add.sprite(objectsPosition[randomPositionArray[9]].x, objectsPosition[randomPositionArray[9]].y, sCollection[randomObjectArray[4]].name);
            ...
            this.wrongObjects[9].name = sCollection[randomObjectArray[4]].name;
            this.wrongObjects[9].trans = sCollection[randomObjectArray[4]].trans;
