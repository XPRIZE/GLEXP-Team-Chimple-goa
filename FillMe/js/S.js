    ...
    var S = {
        ...
        preload: function () {
            ...
            this.rightPath = sPath;
            this.wrongPath = hPath;
            
            this.bgLetter = sLetter;
            ...
            for(var i=0;i<10;i++){
                ...
                this.load.image(sCollection[i].trans, this.rightPath + sCollection[i].trans + imageExtension);
                this.load.image(sCollection[i].name,this.rightPath + sCollection[i].name + imageExtension);
            ...
            for(var i=0;i<10;i++){
                ...
                this.load.image(hCollection[i].trans, this.wrongPath + hCollection[i].trans + imageExtension);  
                this.load.image(hCollection[i].name, this.wrongPath + hCollection[i].name + imageExtension);
            }
        ...
        randomizeObjects: function() {
            ...
            this.rightTrans[0] = game.add.sprite(objectsPosition[randomPositionArray[0]].x,objectsPosition[randomPositionArray[0]].y, sCollection[randomObjectArray[0]].trans);
            this.rightTrans[0].anchor.setTo(spriteAnchorX, spriteAnchorY);
            this.rightTrans[0].scale.setTo(scale.x/4, scale.y/4);
          
            
            this.rightTrans[1] = game.add.sprite(objectsPosition[randomPositionArray[1]].x,objectsPosition[randomPositionArray[1]].y, sCollection[randomObjectArray[1]].trans);
            this.rightTrans[1].anchor.setTo(spriteAnchorX, spriteAnchorY);
            this.rightTrans[1].scale.setTo(scale.x/4, scale.y/4);
          
            
            this.rightTrans[2] = game.add.sprite(objectsPosition[randomPositionArray[2]].x,objectsPosition[randomPositionArray[2]].y, sCollection[randomObjectArray[2]].trans);
            this.rightTrans[2].anchor.setTo(spriteAnchorX, spriteAnchorY);
            this.rightTrans[2].scale.setTo(scale.x/4, scale.y/4);
          
            
            this.rightTrans[3] = game.add.sprite(objectsPosition[randomPositionArray[3]].x,objectsPosition[randomPositionArray[3]].y, sCollection[randomObjectArray[3]].trans);
            this.rightTrans[3].anchor.setTo(spriteAnchorX, spriteAnchorY);
            this.rightTrans[3].scale.setTo(scale.x/4, scale.y/4);
          
            
            this.rightTrans[4] = game.add.sprite(objectsPosition[randomPositionArray[4]].x,objectsPosition[randomPositionArray[4]].y, sCollection[randomObjectArray[4]].trans);
            ...
            this.rightObjects[0] = game.add.sprite(objectsPosition[randomPositionArray[0]].x,objectsPosition[randomPositionArray[0]].y, sCollection[randomObjectArray[0]].name);
            ...
            this.rightObjects[0].name = sCollection[randomObjectArray[0]].name;
            this.rightObjects[0].trans = sCollection[randomObjectArray[0]].trans;
            ...
            this.rightObjects[1] = game.add.sprite(objectsPosition[randomPositionArray[1]].x,objectsPosition[randomPositionArray[1]].y, sCollection[randomObjectArray[1]].name);
            ...
            this.rightObjects[1].name = sCollection[randomObjectArray[1]].name;
            this.rightObjects[1].trans = sCollection[randomObjectArray[1]].trans;
            ...
            this.rightObjects[2] = game.add.sprite(objectsPosition[randomPositionArray[2]].x,objectsPosition[randomPositionArray[2]].y, sCollection[randomObjectArray[2]].name);
            ...
            this.rightObjects[2].name = sCollection[randomObjectArray[2]].name;
            this.rightObjects[2].trans = sCollection[randomObjectArray[2]].trans;
            ...
            this.rightObjects[3] = game.add.sprite(objectsPosition[randomPositionArray[3]].x,objectsPosition[randomPositionArray[3]].y, sCollection[randomObjectArray[3]].name);
            ...
            this.rightObjects[3].name = sCollection[randomObjectArray[3]].name;
            this.rightObjects[3].trans = sCollection[randomObjectArray[3]].trans;
            ...
            this.rightObjects[4] = game.add.sprite(objectsPosition[randomPositionArray[4]].x,objectsPosition[randomPositionArray[4]].y, sCollection[randomObjectArray[4]].name);
            ...
            this.rightObjects[4].name = sCollection[randomObjectArray[4]].name;
            this.rightObjects[4].trans = sCollection[randomObjectArray[4]].trans;
            ...
            this.wrongTrans[5] = game.add.sprite(objectsPosition[randomPositionArray[5]].x,objectsPosition[randomPositionArray[5]].y, hCollection[randomObjectArray[0]].trans);
            this.wrongTrans[5].anchor.setTo(spriteAnchorX, spriteAnchorY);
            this.wrongTrans[5].scale.setTo(scale.x/4, scale.y/4);
            
            
            this.wrongTrans[6] = game.add.sprite(objectsPosition[randomPositionArray[6]].x,objectsPosition[randomPositionArray[6]].y, hCollection[randomObjectArray[1]].trans);
            this.wrongTrans[6].anchor.setTo(spriteAnchorX, spriteAnchorY);
            this.wrongTrans[6].scale.setTo(scale.x/4, scale.y/4);
            
            
            this.wrongTrans[7] = game.add.sprite(objectsPosition[randomPositionArray[7]].x,objectsPosition[randomPositionArray[7]].y, hCollection[randomObjectArray[2]].trans);
            this.wrongTrans[7].anchor.setTo(spriteAnchorX, spriteAnchorY);
            this.wrongTrans[7].scale.setTo(scale.x/4, scale.y/4);
            
            
            this.wrongTrans[8] = game.add.sprite(objectsPosition[randomPositionArray[8]].x,objectsPosition[randomPositionArray[8]].y, hCollection[randomObjectArray[3]].trans);
            this.wrongTrans[8].anchor.setTo(spriteAnchorX, spriteAnchorY);
            this.wrongTrans[8].scale.setTo(scale.x/4, scale.y/4);
            
            
            this.wrongTrans[9] = game.add.sprite(objectsPosition[randomPositionArray[9]].x,objectsPosition[randomPositionArray[9]].y, hCollection[randomObjectArray[4]].trans);
            ...
            this.wrongObjects[5] =  game.add.sprite(objectsPosition[randomPositionArray[5]].x, objectsPosition[randomPositionArray[5]].y, hCollection[randomObjectArray[0]].name);
            ...
            this.wrongObjects[5].name = hCollection[randomObjectArray[0]].name;
            this.wrongObjects[5].trans = hCollection[randomObjectArray[0]].trans;
            ...
            this.wrongObjects[6] =  game.add.sprite(objectsPosition[randomPositionArray[6]].x, objectsPosition[randomPositionArray[6]].y, hCollection[randomObjectArray[1]].name);
            ...
            this.wrongObjects[6].name = hCollection[randomObjectArray[1]].name;
            this.wrongObjects[6].trans = hCollection[randomObjectArray[1]].trans;
            ...
            this.wrongObjects[7] =  game.add.sprite(objectsPosition[randomPositionArray[7]].x, objectsPosition[randomPositionArray[7]].y, hCollection[randomObjectArray[2]].name);
            ...
            this.wrongObjects[7].name = hCollection[randomObjectArray[2]].name;
            this.wrongObjects[7].trans = hCollection[randomObjectArray[2]].trans;
            ...
            this.wrongObjects[8] =  game.add.sprite(objectsPosition[randomPositionArray[8]].x, objectsPosition[randomPositionArray[8]].y, hCollection[randomObjectArray[3]].name);
            ...
            this.wrongObjects[8].name = hCollection[randomObjectArray[3]].name;
            this.wrongObjects[8].trans = hCollection[randomObjectArray[3]].trans;
            ...
            this.wrongObjects[9] =  game.add.sprite(objectsPosition[randomPositionArray[9]].x, objectsPosition[randomPositionArray[9]].y, hCollection[randomObjectArray[4]].name);
            ...
            this.wrongObjects[9].name = hCollection[randomObjectArray[4]].name;
            this.wrongObjects[9].trans = hCollection[randomObjectArray[4]].trans;
