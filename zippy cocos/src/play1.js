...
var Play1Layer = cc.Layer.extend({
    ...
    ctor:function () {
        ...
        tileTypes = ["Fruit_a.png", "Fruit_b.png", "Fruit_d.png","Fruit_j.png","Fruit_i.png","Fruit_w.png"];
        var size = cc.winSize;
        tileGrid = [];
        var level2BG = new cc.Sprite(cc.spriteFrameCache.getSpriteFrame("Fruit_Level.png"));
          ...
          for(var i = 0; i< matches.length; i++){
               ...
               for (var j = 0; j< x.length; j++){
                  ...
                  // cc.log( tileGrid);
                   ...
                   cc.log(imagePath);
                 //  console.log(x[j].Id );
                if(x[j].Id == "Fruit_a.png" )
                {
                   cc.audioEngine.playEffect(res.A_mp3); 
                }
                else if (x[j].Id == "Fruit_b.png")
                {
                   cc.audioEngine.playEffect(res.B_mp3); 
                }
                else if (x[j].Id == "Fruit_d.png")
                {
                   cc.audioEngine.playEffect(res.D_mp3); 
                }
                else if (x[j].Id == "Fruit_j.png")
                {
                   cc.audioEngine.playEffect(res.J_mp3); 
                }
                 else if (x[j].Id == "Fruit_i.png")
                {
                   cc.audioEngine.playEffect(res.I_mp3);  
                }
                  else if (x[j].Id == "Fruit_w.png")
                {
                   cc.audioEngine.playEffect(res.W_mp3,false);   
                }
                  flag = true;
