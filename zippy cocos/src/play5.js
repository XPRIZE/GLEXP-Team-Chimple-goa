...
var Play5Layer = cc.Layer.extend({
    ...
    ctor:function () {
        ...
        tileTypes = ["ToyTrain_A.png", "ToyTrain_B.png", "ToyTrain_C.png","ToyTrain_D.png","ToyTrain_E.png","ToyTrain_F.png"];
        var size = cc.winSize;
        tileGrid = [];
        var level2BG = new cc.Sprite(res.toytrain);
