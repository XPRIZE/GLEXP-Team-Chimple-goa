var Menu5Layer = cc.Layer.extend({
      ...
      ctor:function () {
        ...
        var size = cc.winSize;
        console.log("loading");
        var nameLabel = new cc.LabelTTF('LEVEL 5','Arial', 70 );
		nameLabel.setAnchorPoint(0.5,0.5); 
        nameLabel.x = size.width / 2;
        nameLabel.y = size.height / 2; 
         ...
         if (cc.rectContainsPoint(targetRectangle, location))
                   {
                       ...
                       if(target.id == "LevelBG"){
                         //  console.log("aaaa");
                       cc.director.runScene(new Play5Scene());      
                       }
                   }
       }
  ...
  var Menu5Scene = cc.Scene.extend({
    ctor:function () {
        this._super();
        var layer = new Menu5Layer();
        this.addChild(layer);
    }
});
