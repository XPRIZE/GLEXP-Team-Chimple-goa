var Menu3Layer = cc.Layer.extend({
      ...
      ctor:function () {
        ...
        var size = cc.winSize;
        console.log("loading");
        var nameLabel = new cc.LabelTTF('LEVEL 3','Arial', 70 );
         ...
         if (cc.rectContainsPoint(targetRectangle, location))
                   {
                       ...
                       if(target.id == "LevelBG"){
                         //  console.log("aaaa");
                       cc.director.runScene(new Play3Scene());      
                       }
                   }
       }
  ...
  var Menu3Scene = cc.Scene.extend({
    ctor:function () {
        this._super();
        var layer = new Menu3Layer();
        this.addChild(layer);
    }
});
