...
var Play4Layer = cc.Layer.extend({
    ...
    ctor:function () {
        ...
        tileTypes = ["Block_A.png", "Block_B.png", "Block_C.png","Block_D.png","Block_E.png","Block_F.png"];
        var size = cc.winSize;
        tileGrid = [];
        var level2BG = new cc.Sprite(cc.spriteFrameCache.getSpriteFrame("Block_Level.png"));
