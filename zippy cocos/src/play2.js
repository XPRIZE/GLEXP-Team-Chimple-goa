...
var Play2Layer = cc.Layer.extend({
    ...
    ctor:function () {
        ...
        tileTypes = ["Coin_1.png", "Coin_2.png", "Coin_3.png","Coin_4.png","Coin_5.png","Coin_6.png"];
        var size = cc.winSize;
        tileGrid = [];
        var level2BG = new cc.Sprite(cc.spriteFrameCache.getSpriteFrame("Coin_Level.png"));
          ...
          for(var i = 0; i< matches.length; i++){
               ...
               for (var j = 0; j< x.length; j++){
                  ...
                  // cc.log( tileGrid);
                   ...
                   cc.log(imagePath);
                 //  console.log(x[j].Id );
                if(x[j].Id == "Coin_1.png" )
                {
                   cc.audioEngine.playEffect(res.s1_mp3); 
                }
                else if (x[j].Id == "Coin_2.png")
                {
                   cc.audioEngine.playEffect(res.s2_mp3); 
                }
                else if (x[j].Id == "Coin_3.png")
                {
                   cc.audioEngine.playEffect(res.s3_mp3); 
                }
                else if (x[j].Id == "Coin_4.png")
                {
                   cc.audioEngine.playEffect(res.s4_mp3); 
                }
                 else if (x[j].Id == "Coin_5.png")
                {
                   cc.audioEngine.playEffect(res.s5_mp3);  
                }
                  else if (x[j].Id == "Coin_6.png")
                {
                   cc.audioEngine.playEffect(res.s6_mp3,false);   
                }
                  flag = true;
