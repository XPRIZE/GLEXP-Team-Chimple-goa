var Menu6Layer = cc.Layer.extend({
      ...
      ctor:function () {
        ...
        var size = cc.winSize;
        console.log("loading");
        var nameLabel = new cc.LabelTTF('LEVEL 6','Arial', 70 );
         ...
         if (cc.rectContainsPoint(targetRectangle, location))
                   {
                       ...
                       if(target.id == "LevelBG"){
                         //  console.log("aaaa");
                       cc.director.runScene(new Play6Scene());      
                       }
                   }
       }
  ...
  var Menu6Scene = cc.Scene.extend({
    ctor:function () {
        this._super();
        var layer = new Menu6Layer();
        this.addChild(layer);
    }
});
