var Menu4Layer = cc.Layer.extend({
      ...
      ctor:function () {
        ...
        var size = cc.winSize;
        console.log("loading");
        var nameLabel = new cc.LabelTTF('LEVEL 4','Arial', 70 );
         ...
         if (cc.rectContainsPoint(targetRectangle, location))
                   {
                       ...
                       if(target.id == "LevelBG"){
                         //  console.log("aaaa");
                       cc.director.runScene(new Play4Scene());      
                       }
                   }
       }
  ...
  var Menu4Scene = cc.Scene.extend({
    ctor:function () {
        this._super();
        var layer = new Menu4Layer();
        this.addChild(layer);
    }
});
