...
var Play6Layer = cc.Layer.extend({
    sprite:null,
    zippyLayer: null,
    fieldSize : 5,
    tileTypes : [],
    ...
    ctor:function () {
        ...
        tileTypes = ["Cupcake_a.png", "Cupcake_b.png", "Cupcake_c.png","Cupcake_d.png","Cupcake_e.png","Cupcake_f.png"];
        var size = cc.winSize;
        tileGrid = [];
        var level2BG = new cc.Sprite(cc.spriteFrameCache.getSpriteFrame("Cupcake_Level.png"));
...
var Play6Scene = cc.Scene.extend({
    ctor:function () {
        this._super();
        var layer = new Play6Layer();
        this.addChild(layer);
    }
});
