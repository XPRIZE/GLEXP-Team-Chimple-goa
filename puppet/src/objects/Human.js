...
>>>>>>> Stashed changes
  ...
  setSkinColor(key, frame) {
    this.body.bodyColor = frame;
  }
  ...
  setSpecialShirt(key, frame) {
    this.body.addAccessory(new Accessory(this.game, true, true, true, new Phaser.Point(0.5, 1), new Phaser.Point(0.5, 1), new Phaser.Point(0, 70), false, key, frame, 'specialShirt'), true);
  }
  ...
  setPants(key, frame) {
    this.leftLeg.addAccessory(new Accessory(this.game, false, true, true, new Phaser.Point(0.5, 0), new Phaser.Point(0.5, 0), new Phaser.Point(0, -20), false, key, frame, 'leftPant'), true);
    this.rightLeg.addAccessory(new Accessory(this.game, false, true, true, new Phaser.Point(0.5, 0), new Phaser.Point(0.5, 0), new Phaser.Point(0, -20), false, key, frame, 'rightPant'), true);
  }
  ...
  static buildDefault(game) {
    ...
    human.body.sendToBack(human.leftLeg);
    ...
    human.body.sendToBack(human.rightLeg);

    //human.body.mask = new Phaser.RoundedRectangle(0, 0, 320, 400, 10);
    //human.setSpecialShirt('2', 'pants/pinkskirt_skirt.png');
