...
var checkFlag=0 ;
var checkFlag1=0;
var ans, back, forward;
var textOpt, backFlag4, backFlag5, backFlag3;
var textOverans;
var c =0;
...
var playState0 = {
	...
	preload: function(){
								...
								game.load.image('panelFru','assets/fruit&veg/panelFru.png');
								game.load.image('panel1','assets/ansPanel1.png');
								game.load.image('fruitBg','assets/fruit&veg/fruitBg.png');							
								game.load.image('1dark','assets/1dark.png');
								game.load.image('home','assets/home.png');
								game.load.image('home1','assets/home1.png');
								game.load.image('back','assets/back.png');
								game.load.image('forw','assets/forw.png');
								
								game.load.image('banana','assets/fruit&veg/banana.png');
								game.load.image('peach','assets/fruit&veg/peach.png');	
								game.load.image('spinach','assets/fruit&veg/spinach.png');
								game.load.image('lemon','assets/fruit&veg/lemon.png');	
								game.load.image('mango','assets/fruit&veg/mango.png');	
								game.load.image('potato','assets/fruit&veg/potato.png');	
								game.load.image('radish','assets/fruit&veg/radish.png');
								game.load.image('orange','assets/fruit&veg/orange.png');
								game.load.image('peas','assets/fruit&veg/peas.png');	
	},

	gameLayout: function(){

									this.bg = game.add.image(0,0,'fruitBg');
									this.bg.alpha= .8;
									...
									this.panel = game.add.image(0,game.world.centerY+230, 'panelFru');

									back = game.add.image(game.world.centerX-520,game.world.centerY+330,'back');
									...
									forward = game.add.image(game.world.centerX+520,game.world.centerY+330,'forw');
									...
									if(backFlag4 ==1)
									{
										...
										//checkFlag1=0
										 game.add.tween(back).to({alpha:1},500, Phaser.Easing.Cubic.Out, true)
										 ...
										 back.events.onInputDown.add(function(){
										 	 ...
										 	 game.add.tween(back.scale).to({x: 0.7, y: 0.7}, 150, Phaser.Easing.Cubic.Out, true);
  											 game.add.tween(back.scale).to({x: .8, y: .8}, 150, Phaser.Easing.Cubic.Out, true, 150)
										 	
										    game.time.events.add(300, this.gameLayout, this);                          				
	                          			   	game.time.events.add(300, this.word3, this);}, this);
									...
									if(backFlag5 ==1)
									{
										backFlag4 = 1;
										 ...
										 back.events.onInputDown.add(function(){
										 	...
										 	game.time.events.add(300, this.gameLayout, this);                          				
                          					game.time.events.add(300, this.word4, this);}, this);
								...
								var posY= game.world.centerY-365;
							 	var addX= 0;game.world.centerX-575,game.world.centerY-340
								var addY = 0;
	...
	word3:function(){
							...
							//var prop4= ['P', 'A', 'P', ' ', ' ', 'A'];
								...
								this.prop1 = game.add.sprite(squarePos[50].X+23,squarePos[50].Y, 'radish',0,this.props);
								...
								this.prop3 = game.add.sprite(squarePos[13].X-5,squarePos[13].Y-30, 'potato', 0, this.props);
								//this.prop3.scale.x = .7;
								//this.prop3.scale.y = .7;
								...
								this.prop2 = game.add.sprite(squarePos[20].X+23,squarePos[20].Y, 'spinach',0,this.props);
								this.prop2.scale.x = .8;
								this.prop2.scale.y = .8;
								this.prop2.anchor.setTo(.5,.5);

								this.prop2Tween=game.add.tween(this.prop2);
								this.prop2Tween.to({y:this.prop2.position.y-15},2500, Phaser.Easing.Linear.None);
								this.prop2Tween.to({y:this.prop2.position.y},2500, Phaser.Easing.Linear.None);
						...
						var d =0
							...
							this.text.anchor.setTo(.5,.5);
								...
								if(i<6)
								{
								var textXprop2 = squarePos[23+c12].X;
								var textYprop2= squarePos[23+c12].Y;
							...
							this.text.anchor.setTo(.5,.5);
								...
								var textXprop3 = squarePos[52+c1].X;
								var textYprop3= squarePos[52+c1].Y;
						...
						//console.log(panIdOrg);
							...
							var letterAns = ['N','J', 'T', 'N', 'H', 'V', 'B', 'H', 'S','F', 'R', 'O', 'A', 'I', 'K', 'C'];
...
word5:function(){
							...
							var prop5= [' ', 'E', 'A', ' '];
								...
								this.prop1 = game.add.sprite(squarePos[40].X+25,squarePos[41].Y-18, 'mango',0,this.props);
								...
								this.prop3 = game.add.sprite(squarePos[2].X-5,squarePos[2].Y+25, 'lemon', 0, this.props);
								...
								this.prop4 = game.add.sprite(squarePos[4].X-33,squarePos[4].Y-20, 'banana',0,this.props);
								...
								this.prop2 = game.add.sprite(squarePos[26].X-65,squarePos[16].Y+40, 'orange',0,this.props);
								this.prop2.scale.x = .8;
								this.prop2.scale.y = .8;
								...
								this.prop5 = game.add.sprite(squarePos[94].X-15,squarePos[94].Y-25, 'peas',0,this.props);
						...
						var d =0
							...
							{  
								...
								var textXprop1 = squarePos[22+c12].X;
								var textYprop1 = squarePos[22+c12].Y;
							...
							this.text.anchor.setTo(.5,.5);
								...
								var textXprop2 = squarePos[42+c1].X;
								var textYprop2= squarePos[42+c1].Y;
							...
							this.text.anchor.setTo(.5,.5);
								...
								var textXprop4 = squarePos[46+c12].X;
								var textYprop4= squarePos[46+c12].Y;
								...
								if(i<4)
							{
								var textXprop5 = squarePos[95+c1].X;
								var textYprop5= squarePos[95+c1].Y;
						...
						//console.log(panIdOrg);
							...
							var letterAns = ['J','B', 'P', 'S', 'E', 'K', 'A', 'R', 'G','V', 'S', 'C', 'N', 'M', 'I', 'A'];
							this.option= game.add.group();
							optionPosx = game.world.centerX-350;
							optionPosy = game.world.centerY+285;
							optionAddx = 0;
	...
	word4:function(){
							...
							var prop4= ['P', 'A', 'P', ' ', ' ', 'A'];
								...
								this.prop1 = game.add.sprite(squarePos[41].X+15,squarePos[41].Y-18, 'apple',0,this.props);
								this.prop1.scale.x = .8;
								this.prop1.scale.y = .8;
								this.prop1.anchor.setTo(.5,.5);
								...
								this.prop3 = game.add.sprite(squarePos[3].X-5,squarePos[3].Y+25, 'grapes', 0, this.props);
								this.prop3.scale.x = .8;
								this.prop3.scale.y = .8;
								this.prop3.anchor.setTo(.5,.5);
								...
								this.prop4 = game.add.sprite(squarePos[5].X-33,squarePos[5].Y-20, 'papaya',0,this.props);
								this.prop4.scale.x = .8;
								this.prop4.scale.y = .8;
								...
								this.prop2 = game.add.sprite(squarePos[17].X-43,squarePos[17].Y-20, 'peach',0,this.props);
								this.prop2.scale.x = .8;
								this.prop2.scale.y = .8;
						...
						var d =0
							...
							this.text.anchor.setTo(.5,.5);
								...
								var textXprop3 = squarePos[23+c12].X;
								var textYprop3= squarePos[23+c12].Y;
								...
								var textXprop4 = squarePos[25+c12].X;
								var textYprop4= squarePos[25+c12].Y;
						...
						//console.log(panIdOrg);
							...
							var letterAns = ['A','X', 'E', 'T', 'P', 'R', 'S', 'L', 'A','X', 'Y', 'T', 'A', 'R', 'H', 'Q'];
							this.option= game.add.group();
							optionPosx = game.world.centerX-350;
							optionPosy = game.world.centerY+285;
							optionAddx = 0;
						...
						for(var t=0; t<2; t++)
	            			...
	            			ans.scale.setTo(.9,.9); 
	                   		...
	                   		//this.text =game.add.text(optionRealx, optionRealy, appleX[t],{font:'30px solid arial'});
	                   		textOpt  =game.add.text(optionRealx, optionRealy, letterAns[f],style);
							//add.text(optionRealx, optionRealy, letterAns[f],style);
...
colorChangeAlpha: function(){
									...
									var flag4 =0;
									 	...
									 	if(  panIdOrg[0].position.x == panId[4].position.x )
                          	{
                          		...
                          		flag1 = 1;
                   					 ...
                   					 if(panIdOrg[1].position.y == panId[5].position.y && panIdOrg[5].position.y == panId[2].position.y
                          					&& panIdOrg[1].position.x == panId[5].position.x && panIdOrg[5].position.x == panId[2].position.x)
                          			{
                          		...
                          		if(panIdOrg[1].position.y == panId[13].position.y && panIdOrg[5].position.y == panId[2].position.y
                          				&& panIdOrg[1].position.x == panId[13].position.x && panIdOrg[5].position.x == panId[2].position.x)
                          			{
                          				panIdOrg[5].inputEnabled = false;
                          				panIdOrg[1].inputEnabled = false;
						 ...
						 if(panIdOrg[3].position.y == panId[0].position.y  && panIdOrg[6].position.y == panId[10].position.y && 

									panIdOrg[3].position.x == panId[0].position.x  && panIdOrg[6].position.x == panId[10].position.x)
                          	 ...
                          	 if(panIdOrg[3].position.y == panId[8].position.y  && panIdOrg[6].position.y == panId[10].position.y
                          						&& panIdOrg[3].position.x== panId[8].position.x  && panIdOrg[6].position.x == panId[10].position.x )
									 ...
									 if(panIdOrg[3].position.y == panId[12].position.y  && panIdOrg[6].position.y == panId[10].position.y 
												&& panIdOrg[3].position.x == panId[12].position.x  && panIdOrg[6].position.x == panId[10].position.x)

                          			{

                          					panIdOrg[3].inputEnabled = false;
                          					panIdOrg[6].inputEnabled = false;
                          							console.log("I AM IN 3rd loop position is 12 of papaya ");
                          			 ...
                          			 if(panIdOrg[2].position.y == panId[0].position.y  && panIdOrg[4].position.y == panId[14].position.y 
                          				&& panIdOrg[2].position.x == panId[0].position.x && panIdOrg[4].position.x == panId[14].position.x)
                          		{	
                         				...
                         				flag4=1;
		                          		...
		                          		ansName[0].kill();                          			
                          					 ...
                          					 if(panIdOrg[2].position.y == panId[8].position.y && panIdOrg[4].position.y == panId[14].position.y 
                          					 && panIdOrg[2].position.x == panId[8].position.x && panIdOrg[4].position.x == panId[14].position.x)
                          			{
                          				...
                          				console.log("I AM IN 2nd loop position is 8");
                          				flag4=1;
	                          			ansName[14].kill();
	                          			ansName[8].kill();
											 ...
											 if(panIdOrg[2].position.y == panId[12].position.y && panIdOrg[4].position.y == panId[14].position.y 
												&& panIdOrg[2].position.x == panId[12].position.x && panIdOrg[4].position.x == panId[14].position.x)
                          			{	

                          				panIdOrg[2].inputEnabled = false;
                          				panIdOrg[4].inputEnabled = false;
                          		
                          				console.log("I AM IN 3rd loop position is 12 ");
                          				flag4=1;
		                          		ansName[14].kill();
		                          		ansName[12].kill();
                          			...
                          			if(flag1==1 && flag2==1 && flag3==1 && flag4==1)
                          			{
										...
										backFlag5 =1;
										 c =0;
										  ...
										  game.add.tween(forward).to({alpha:1},500, Phaser.Easing.Cubic.Out, true)
										
											 forward.events.onInputDown.add(function(){

										 	 game.add.tween(forward.scale).to({x: 0.7, y: 0.7}, 150, Phaser.Easing.Cubic.Out, true);
  											 game.add.tween(forward.scale).to({x: .8, y: .8}, 150, Phaser.Easing.Cubic.Out, true, 150)
										 	
										 	game.time.events.add(300, this.gameLayout, this);                          				
                          					game.time.events.add(300, this.word5, this);}, this);
										 console.log(panId);
										 console.log(panIdOrg);
										 console.log(pankaj10);
										 console.log(squarePos);
    ...
    colorChangeBeta: function(){
									...
									var flag4 =0;
									 	...
									 	if(  panIdOrg[1].position.y == panId[2].position.y && panIdOrg[4].position.y == panId[11].position.y
                          					&& panIdOrg[1].position.x == panId[2].position.x && panIdOrg[4].position.x == panId[11].position.x )
                          	{
                          		panIdOrg[1].inputEnabled = false;
                          		ansName[2].kill();
                          		panIdOrg[4].inputEnabled = false;
                          		...
                          		flag1 = 1;
                   					 ...
                   					 if(panIdOrg[0].position.y == panId[13].position.y && panIdOrg[3].position.y == panId[15].position.y
                          					&& panIdOrg[0].position.x == panId[13].position.x && panIdOrg[3].position.x == panId[15].position.x
                          					&& panIdOrg[6].position.x == panId[4].position.x && panIdOrg[6].position.y == panId[4].position.y)
                          			{
                          				panIdOrg[0].inputEnabled = false;
                          				panIdOrg[3].inputEnabled = false;
                          				panIdOrg[6].inputEnabled = false;
                          		...
                          		if(panIdOrg[0].position.y == panId[13].position.y && panIdOrg[3].position.y == panId[15].position.y
                          					&& panIdOrg[0].position.x == panId[13].position.x && panIdOrg[3].position.x == panId[15].position.x
                          					&& panIdOrg[6].position.x == panId[7].position.x && panIdOrg[6].position.y == panId[7].position.y)
                          			{
                          				panIdOrg[0].inputEnabled = false;
                          				panIdOrg[3].inputEnabled = false;
                          				panIdOrg[6].inputEnabled = false;
						 ...
						 if( panIdOrg[2].position.y == panId[8].position.y && panIdOrg[5].position.y == panId[4].position.y
                          					&& panIdOrg[2].position.x == panId[8].position.x && panIdOrg[5].position.x == panId[4].position.x )
                          	 ...
                          	 if( panIdOrg[2].position.y == panId[8].position.y && panIdOrg[5].position.y == panId[7].position.y
                          					&& panIdOrg[2].position.x == panId[8].position.x && panIdOrg[5].position.x == panId[7].position.x)
                          			...
                          			if(flag1==1 && flag2==1 && flag3==1 )
                          			{
										...
										backFlag4=1;
										 ...
										 forward.events.onInputDown.add(function(){
										 	...
										 	game.time.events.add(300, this.gameLayout, this);                          				
                          					game.time.events.add(300, this.word4, this);
    ...
    colorChangeGama: function(){
									...
									var flag5 =0;
									 	...
									 	if(  panIdOrg[1].position.y == panId[2].position.y && panIdOrg[6].position.y == panId[10].position.y
                          					&& panIdOrg[1].position.x == panId[2].position.x && panIdOrg[6].position.x == panId[10].position.x )
                          	{
                          		panIdOrg[1].inputEnabled = false;
                          		ansName[2].kill();
                          		panIdOrg[6].inputEnabled = false;
                          		...
                          		flag1 = 1;
									 	...
									 	if(  panIdOrg[1].position.y == panId[2].position.y && panIdOrg[6].position.y == panId[3].position.y
                          					&& panIdOrg[1].position.x == panId[2].position.x && panIdOrg[6].position.x == panId[3].position.x )
                          	{
                          		panIdOrg[1].inputEnabled = false;
                          		ansName[2].kill();
                          		panIdOrg[6].inputEnabled = false;
                          		...
                          		flag1 = 1;
                   					 ...
                   					 if(panIdOrg[2].position.y == panId[4].position.y && panIdOrg[7].position.y == panId[12].position.y
                          					&& panIdOrg[2].position.x == panId[4].position.x && panIdOrg[7].position.x == panId[12].position.x
                          				)
                          			{
                          				panIdOrg[2].inputEnabled = false;
                          				panIdOrg[7].inputEnabled = false;
                          		...
                          		if(panIdOrg[4].position.y == panId[7].position.y 	&& panIdOrg[4].position.x == panId[7].position.x)
						 ...
						 if( panIdOrg[0].position.y == panId[1].position.y && panIdOrg[8].position.y == panId[6].position.y
                          					&& panIdOrg[0].position.x == panId[1].position.x && panIdOrg[8].position.x == panId[6].position.x )

                          			{
                          						console.log("I AM IN 3rd loop position is 0 of papaya");
                          						panIdOrg[0].inputEnabled = false;
                          						panIdOrg[8].inputEnabled = false;
                          	 ...
                          	 if( panIdOrg[0].position.y == panId[1].position.y && panIdOrg[8].position.y == panId[15].position.y
                          					&& panIdOrg[0].position.x == panId[1].position.x && panIdOrg[8].position.x == panId[15].position.x )

                          			{
                          	     	 ...
                          	     	 if( panIdOrg[5].position.y == panId[8].position.y && panIdOrg[3].position.y == panId[6].position.y
                          					&& panIdOrg[5].position.x == panId[8].position.x && panIdOrg[3].position.x == panId[6].position.x )

                          			{
                          	     	 ...
                          	     	 if( panIdOrg[5].position.y == panId[8].position.y && panIdOrg[3].position.y == panId[15].position.y
                          					&& panIdOrg[5].position.x == panId[8].position.x && panIdOrg[3].position.x == panId[15].position.x )
										 ...
										 game.add.tween(forward).to({alpha:1},500, Phaser.Easing.Cubic.Out, true)
											 ...
											 forward.events.onInputDown.add(function(){
										 	 ...
										 	 game.add.tween(forward.scale).to({x: 0.7, y: 0.7}, 150, Phaser.Easing.Cubic.Out, true);
  											 ...
  											 setTimeout(function(){ game.state.start('game2State1'); }, 1000);
                          			...
                          			//	 setTimeout(function(){ game.state.start('game2State1'); }, 3000);
