...
var playState6= {
	...
	preload: function(){
								...
								game.load.image('panelGeo','assets/geo/panelGeo.png');
								game.load.image('panel1','assets/ansPanel1.png');
								game.load.image('1dark','assets/1dark.png');
								game.load.image('home','assets/home.png');
								game.load.image('circle','assets/geo/circle.png');
								game.load.image('cone','assets/geo/cone.png');
								game.load.image('rectangle','assets/geo/rectangle.png');
								game.load.image('pyramid','assets/geo/pyramid.png');
								game.load.image('prism','assets/geo/prism.png');
								game.load.image('drafter','assets/geo/drafter.png');
								game.load.image('triangle','assets/geo/triangle.png');
								game.load.image('pyramid','assets/geo/pyramid.png');
								game.load.image('star','assets/geo/star.png');
								game.load.image('cylinder','assets/geo/cylinder.png');
								game.load.image('compass','assets/geo/compass.png');
								game.load.image('geoBg','assets/geo/geoBg.png');
								game.load.image('hexagon','assets/geo/hexagon.png');
								game.load.image('cube','assets/geo/cube.png');
	...
	gameLayout: function(){
									...
									this.bg = game.add.image(0,0,'geoBg');
									this.bg.alpha= .8;
								...
								this.panel = game.add.image(0,game.world.centerY+230, 'panelGeo');
	...
	word3:function(){
							...
							var prop1 = ['C', ' ', 'L', 'I', 'N', 'D', 'E',' '];
							var prop2=  [' ', 'R', 'I', 'A',' ', 'G','L', 'E'];
							var prop3 = ['C', 'I', 'R', ' ', 'L', 'E'];
							//var prop4= ['P', 'A', 'P', ' ', ' ', 'A'];

								this.prop1 = game.add.sprite(squarePos[5].X-10,squarePos[5].Y+25, 'triangle',0,this.props);
								...
								this.prop3 = game.add.sprite(squarePos[32].X,squarePos[31].Y-38, 'circle', 0, this.props);
								this.prop3.scale.x = .8;
								this.prop3.scale.y = .8;
								this.prop3.anchor.setTo(.5,.5);

								var prop3Tween=game.add.tween(this.prop3);
								prop3Tween.to({x:this.prop3.position.x+15},2500, Phaser.Easing.Linear.None);
								prop3Tween.to({x:this.prop3.position.x},2500, Phaser.Easing.Linear.None);
								...
								this.prop2 = game.add.sprite(squarePos[40].X+20,squarePos[40].Y-15, 'cylinder',0,this.props);
								this.prop2.scale.x = .8;
								this.prop2.scale.y = .8;
								this.prop2.anchor.setTo(.5,.5);

									this.prop2Tween=game.add.tween(this.prop2);
									this.prop2Tween.to({y:this.prop2.position.y-5},2500, Phaser.Easing.Linear.None);
								this.prop2Tween.to({angle:-45},1500, Phaser.Easing.Quintic.Out);
								this.prop2Tween.to({angle:45},1500, Phaser.Easing.Quintic.Out);
								this.prop2Tween.to({angle:360},1500, Phaser.Easing.Quintic.Out);
						...
						//	this.textOver.add(this.text);
								...
								if(i<6)
						{
								var textXprop3 = squarePos[42+c12].X;
								var textYprop3= squarePos[42+c12].Y;
						...
						//console.log(panIdOrg);
							...
							var letterAns = ['B','H', 'Y', 'K', 'E', 'N', 'R', 'S', 'G','J', 'H', 'I', 'V', 'Q', 'T', 'C'];
...
word5:function() {
							...
							var prop5=  [' ', 'T', 'A', 'R'];
								...
								this.prop1 = game.add.sprite(squarePos[21].X-10,squarePos[21].Y-32, 'drafter',0,this.props);
								this.prop1.scale.x = .8;
								this.prop1.scale.y = .8;
								this.prop1.anchor.setTo(.5,.5);
								...
								this.prop3 = game.add.sprite(squarePos[14].X,squarePos[14].Y+30, 'star', 0, this.props);
								this.prop3.scale.x = .8;
								this.prop3.scale.y = .8;
								this.prop3.anchor.setTo(.5,.5);
								...
								this.prop4 = game.add.sprite(squarePos[82].X-39,squarePos[63].Y+13, 'prism',0,this.props);
								...
								this.prop5 = game.add.sprite(squarePos[40].X,squarePos[40].Y, 'rectangle',0,this.props);
								...
								this.prop2 = game.add.sprite(squarePos[27].X-15,squarePos[7].Y-8, 'cube',0,this.props);
						...
						var d =0
							...
							{
								var textXprop2 = squarePos[31+c12].X;
								var textYprop2= squarePos[31+c12].Y;
							...
							if(i<5)
							{
								var textXprop3 = squarePos[63+c1].X;
								var textYprop3= squarePos[63+c1].Y;
								...
								if(i<4)
								{
								var textXprop4 = squarePos[19+c12].X;
								var textYprop4 = squarePos[19+c12].Y;
								...
								var textXprop5 = squarePos[34+c12].X;
								var textYprop5= squarePos[34+c12].Y;
						...
						//console.log(panIdOrg);
							...
							var letterAns = ['E','K', 'C', 'F', 'Q', 'G', 'R', 'A', 'U','S', 'I', 'H', 'P', 'M', 'T', 'E'];
							this.option= game.add.group();
							optionPosx = game.world.centerX-350;
							optionPosy = game.world.centerY+285;
							optionAddx = 0;
	...
	word4:function(){
							...
							var prop2 = ['C', 'O', ' ', 'P', 'A', ' ', 'S'];
							 ...
							 var prop4= [' ', 'O', 'N', 'E'];
								...
								this.prop1 = game.add.sprite(squarePos[41].X-32,squarePos[41].Y-18, 'hexagon',0,this.props);
								...
								this.prop3 = game.add.sprite(squarePos[12].X-25,squarePos[12].Y-15, 'cone', 0, this.props);
								...
								this.prop4 = game.add.sprite(squarePos[6].X-33,squarePos[6].Y-30, 'pyramid',0,this.props);
								...
								this.prop2 = game.add.sprite(squarePos[16].X+54,squarePos[16].Y-18, 'compass',0,this.props);
						...
						var d =0
							...
							this.text.anchor.setTo(.5,.5);
								...
								var textXprop3 = squarePos[15+c12].X;
								var textYprop3= squarePos[15+c12].Y;
							...
							if(i<4)
							{
								var textXprop4 = squarePos[13+c12].X;
								var textYprop4= squarePos[13+c12].Y;
						...
						//console.log(panIdOrg);
							...
							var letterAns = ['X','T', 'Y', 'H', 'C', 'E', 'J', 'A', 'N','M', 'Q', 'S', 'D', 'Z', 'K', 'L'];
							this.option= game.add.group();
							optionPosx = game.world.centerX-350;
							optionPosy = game.world.centerY+285;
							optionAddx = 0;
...
colorChangeAlpha: function(){
									...
									var flag4 =0;
									 	...
									 	if(  panIdOrg[1].position.x == panId[4].position.x && panIdOrg[1].position.y == panId[4].position.y)
                          	{
                          		...
                          		flag1 = 1;
                   					 ...
                   					 if( panIdOrg[2].position.y == panId[2].position.y && panIdOrg[2].position.x == panId[2].position.x &&
                          				panIdOrg[6].position.y == panId[12].position.y && panIdOrg[6].position.x == panId[12].position.x	 )
                          			{
						 ...
						 if(panIdOrg[0].position.y == panId[3].position.y  && panIdOrg[5].position.y == panId[8].position.y && 
                                panIdOrg[0].position.x == panId[3].position.x  && panIdOrg[5].position.x == panId[8].position.x)
...

                          			{
                          			 ...
                          			 if(panIdOrg[3].position.y == panId[9].position.y
                          				&& panIdOrg[3].position.x == panId[9].position.x && panIdOrg[4].position.y == panId[11].position.y
                          				&& panIdOrg[4].position.x == panId[11].position.x
                          				)
                          		{	
    ...
    colorChangeBeta: function(){
									...
									var flag3 =0;
									 	...
									 	if(  panIdOrg[1].position.y == panId[2].position.y && panIdOrg[4].position.y == panId[6].position.y
                          					&& panIdOrg[1].position.x == panId[2].position.x && panIdOrg[4].position.x == panId[6].position.x 
                          				)
                          	{
                          				panIdOrg[1].inputEnabled = false;
                          				panIdOrg[4].inputEnabled = false;
                          		...
                          		flag1 = 1;
                   					 ...
                   					 if(panIdOrg[0].position.y == panId[14].position.y && panIdOrg[3].position.y == panId[5].position.y
                          					&& panIdOrg[0].position.x == panId[14].position.x && panIdOrg[3].position.x == panId[5].position.x
                          				)
                          			{
                          				panIdOrg[0].inputEnabled = false;
                          				panIdOrg[3].inputEnabled = false;
						 ...
						 if( panIdOrg[2].position.y == panId[15].position.y	
						 		&& panIdOrg[2].position.x == panId[15].position.x )
    ...
    colorChangeGama: function(){
                          					...
                          					&& panIdOrg[3].position.x == panId[2].position.x && panIdOrg[6].position.x == panId[5].position.x )
                          	{
                          		...
                          		flag1 = 1;
                   					 ...
                   					 if(panIdOrg[4].position.y == panId[3].position.y && panIdOrg[7].position.y == panId[6].position.y
                          					&& panIdOrg[4].position.x == panId[3].position.x && panIdOrg[7].position.x == panId[6].position.x
                          				)
                          			{
                          				panIdOrg[4].inputEnabled = false;
                          		...
                          		if(panIdOrg[2].position.y == panId[8].position.y 	&& panIdOrg[2].position.x == panId[8].position.x)
							...
							if(panIdOrg[1].position.y == panId[9].position.y 	&& panIdOrg[1].position.x == panId[9].position.x)
                          		...
                          		flag4=1;
                          	     	 ...
                          	     	 if( panIdOrg[0].position.y == panId[12].position.y && panIdOrg[5].position.x == panId[13].position.x
                          	     	 	&&  panIdOrg[0].position.y == panId[12].position.y && panIdOrg[5].position.x == panId[13].position.x
                          				 )
                          			...
                          			if(flag1==1 && flag2==1 && flag3==1  && flag4==1 && flag5==1 )
                          			{
										...
										// game.time.events.add(4, this.gameLayout, this);                          				
                          				 //game.time.events.add(4, this.word4, this);
                          				  ...
                          				  setTimeout(function(){ game.state.start('game2State7'); }, 3000);
