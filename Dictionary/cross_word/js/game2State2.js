...
var playState2 = {
	...
	preload: function(){
								...
								game.load.image('panelBird','assets/birds/panelBird.png');
								game.load.image('panel1','assets/ansPanel1.png');
								game.load.image('1dark','assets/1dark.png');
								game.load.image('birdBg','assets/birds/birdBg.png');

								game.load.image('crane','assets/birds/crane.png');
								game.load.image('crow','assets/birds/crow.png');
								game.load.image('dove','assets/birds/dove.png');
								game.load.image('duck','assets/birds/duck.png');
								game.load.image('eagle','assets/birds/eagle.png');
								game.load.image('falcon','assets/birds/falcon.png');
								game.load.image('flamingo','assets/birds/flamingo.png');
								game.load.image('ostrich','assets/birds/ostrich.png');
								game.load.image('parrot','assets/birds/parrot.png');
								game.load.image('penguin','assets/birds/penguin.png');
								game.load.image('sparrow','assets/birds/sparrow.png');
								game.load.image('owl','assets/birds/owl.png');
	...
	gameLayout: function(){
								...
								this.panel = game.add.image(0,game.world.centerY+230, 'panelBird');
	...
	word3:function(){
							...
							//var prop4= ['P', 'A', 'P', ' ', ' ', 'A'];
								...
								this.prop1 = game.add.sprite(squarePos[32].X,squarePos[32].Y-35, 'dove',0,this.props);
								...
								this.prop3 = game.add.sprite(squarePos[37].X-5,squarePos[27].Y-30, 'duck', 0, this.props);
								...
								this.prop2 = game.add.sprite(squarePos[51].X-15,squarePos[50].Y-5, 'ostrich',0,this.props);
						...
						var d =0
							...
							{  
								...
								var textXprop1 = squarePos[52+c1].X;
								var textYprop1 = squarePos[52+c1].Y;
						...
						//console.log(panIdOrg);
							...
							var letterAns = ['A','D', 'F', 'J', 'S', 'V', 'U', 'W', 'E','N', 'M', 'Q', 'Y', 'T', 'R', 'K'];
...
word5:function(){
							...
							var prop5=  ['O', ' ', 'L'];
								...
								this.prop1 = game.add.sprite(squarePos[31].X,squarePos[30].Y-18, 'falcon',0,this.props);
								this.prop1.scale.x = .8;
								this.prop1.scale.y = .8;
								this.prop1.anchor.setTo(.5,.5);
								...
								this.prop3 = game.add.sprite(squarePos[13].X-5,squarePos[13].Y+40, 'eagle', 0, this.props);
								this.prop3.scale.x = .8;
								this.prop3.scale.y = .8;
								this.prop3.anchor.setTo(.5,.5);
								...
								this.prop4 = game.add.sprite(squarePos[5].X-59,squarePos[5].Y-20, 'crane',0,this.props);
								...
								this.prop5 = game.add.sprite(squarePos[40].X,squarePos[40].Y, 'flamingo',0,this.props);
								...
								this.prop2 = game.add.sprite(squarePos[37].X+14,squarePos[27].Y-17, 'owl',0,this.props);
								this.prop2.scale.x = .8;
								this.prop2.scale.y = .8;
						...
						var d =0
							...
							{
								var textXprop2 = squarePos[41+c12].X;
								var textYprop2= squarePos[41+c12].Y;
									...
									if(i<5)
						{
								...
								var textXprop4 = squarePos[16+c12].X;
								var textYprop4= squarePos[16+c12].Y;
								...
								if(i<3)
							{
								var textXprop5 = squarePos[48+c12].X;
								var textYprop5= squarePos[48+c12].Y;
						...
						//console.log(panIdOrg);
							...
							var letterAns = ['F','I', 'K', 'G', 'M', 'U', 'E', 'S', 'C','A', 'Z', 'P', 'T', 'W', 'L', 'R'];
							this.option= game.add.group();
							optionPosx = game.world.centerX-350;
							optionPosy = game.world.centerY+285;
							optionAddx = 0;
	...
	word4:function(){
							...
							var prop2 = ['P', 'E', 'N', ' ', ' ', 'I', 'N'];
							 ...
							 var prop4= [' ', 'R', 'O','W'];
								...
								this.prop1 = game.add.sprite(squarePos[30].X+28,squarePos[30].Y-18, 'sparrow',0,this.props);
								this.prop1.scale.x = .8;
								this.prop1.scale.y = .8;
								this.prop1.anchor.setTo(.5,.5);
								...
								this.prop3 = game.add.sprite(squarePos[13].X-5,squarePos[13].Y+30, 'penguin', 0, this.props);
								this.prop3.scale.x = .8;
								this.prop3.scale.y = .8;
								this.prop3.anchor.setTo(.5,.5);
								...
								this.prop4 = game.add.sprite(squarePos[3].X,squarePos[4].Y-15, 'parrot',0,this.props);
								this.prop4.scale.x = .8;
								this.prop4.scale.y = .8;
								...
								this.prop4Tween.start();
									...
									this.prop2 = game.add.sprite(squarePos[8].X-40,squarePos[7].Y-8, 'crow',0,this.props);
						...
						var d =0
							...
							this.text.anchor.setTo(.5,.5);
								...
								if(i<4)
								{
								var textXprop4 = squarePos[17+c12].X;
								var textYprop4= squarePos[17+c12].Y;
						...
						//console.log(panIdOrg);
							...
							var letterAns = ['E','C', 'K', 'L', 'A', 'R', 'W', 'S', 'F','H', 'G', 'O', 'T', 'U', 'V', 'B'];
							this.option= game.add.group();
							optionPosx = game.world.centerX-350;
							optionPosy = game.world.centerY+285;
							optionAddx = 0;
...
colorChangeAlpha: function(){
									...
									var flag4 =0;
									 	...
									 	if(  panIdOrg[0].position.x == panId[1].position.x && panIdOrg[0].position.y == panId[1].position.y)
                          	{
                          		...
                          		flag1 = 1;
                   					 ...
                   					 if(panIdOrg[3].position.y == panId[5].position.y && panIdOrg[5].position.y == panId[11].position.y
                          					&& panIdOrg[3].position.x == panId[5].position.x && panIdOrg[5].position.x == panId[11].position.x)
                          			{
						 ...
						 if(panIdOrg[2].position.y == panId[10].position.y  && panIdOrg[4].position.y == panId[13].position.y && 

									panIdOrg[2].position.x == panId[10].position.x  && panIdOrg[4].position.x == panId[13].position.x)

                          			{
                          			 ...
                          			 if(panIdOrg[1].position.y == panId[4].position.y  && panIdOrg[6].position.y == panId[6].position.y 
                          				&& panIdOrg[1].position.x == panId[4].position.x && panIdOrg[6].position.x == panId[6].position.x
                          				)
                          		{	
                          			...
                          			if(flag1==1 && flag2==1 && flag3==1 && flag4==1)
                          			{
										...
										checkFlag1 = 1;
										 ...
										 game.time.events.add(2000, this.gameLayout, this);                          				
                          				...
                          				console.log('else me gaya h colorChangeNew ke ALPHA');
                          	    	}
    ...
    colorChangeBeta: function(){
									...
									var flag3 =0;
									 	...
									 	if(  panIdOrg[1].position.y == panId[4].position.y && panIdOrg[3].position.y == panId[14].position.y
                          					&& panIdOrg[1].position.x == panId[4].position.x && panIdOrg[3].position.x == panId[14].position.x 
                          				)
                          	{
                          				panIdOrg[1].inputEnabled = false;
                          				panIdOrg[3].inputEnabled = false;
                          		...
                          		flag1 = 1;
                   					 ...
                   					 if(panIdOrg[0].position.y == panId[1].position.y && panIdOrg[5].position.y == panId[15].position.y
                          					&& panIdOrg[0].position.x == panId[1].position.x && panIdOrg[5].position.x == panId[15].position.x
                          					)
                          			{
                          				panIdOrg[0].inputEnabled = false;
                          				panIdOrg[5].inputEnabled = false;
						 ...
						 if( panIdOrg[2].position.y == panId[5].position.y	&& panIdOrg[2].position.x == panId[5].position.x 
						 	&& panIdOrg[4].position.y == panId[8].position.y	&& panIdOrg[4].position.x == panId[8].position.x )
                          			...
                          			if(flag1==1 && flag2==1 && flag3==1 )
                          			{
										...
										checkFlag = 1;
										 ...
										 game.time.events.add(2000, this.gameLayout, this);                          				
                          				...
                          				console.log('else me gaya h colorChangeNew ke BETA');
                          	    	}
    ...
    colorChangeGama: function(){
									...
									var flag5 =0;
									 	...
									 	if(  panIdOrg[4].position.y == panId[4].position.y && panIdOrg[7].position.y == panId[3].position.y
                          					&& panIdOrg[4].position.x == panId[4].position.x && panIdOrg[7].position.x == panId[3].position.x )
                          	{
                          		panIdOrg[4].inputEnabled = false;
                          		ansName[4].kill();
                          		...
                          		flag1 = 1;
                   					 ...
                   					 if(panIdOrg[2].position.y == panId[14].position.y && panIdOrg[5].position.y == panId[8].position.y
                          					&& panIdOrg[2].position.x == panId[14].position.x && panIdOrg[5].position.x == panId[8].position.x
                          				)
                          			{
                          				panIdOrg[2].inputEnabled = false;
                          				panIdOrg[5].inputEnabled = false;
                          		...
                          		if(panIdOrg[6].position.y == panId[6].position.y 	&& panIdOrg[6].position.x == panId[6].position.x)
							...
							if(panIdOrg[1].position.y == panId[13].position.y 	&& panIdOrg[1].position.x == panId[13].position.x)
                          		...
                          		flag4=1;
                          	     	 ...
                          	     	 if( panIdOrg[0].position.y == panId[15].position.y && panIdOrg[3].position.y == panId[9].position.y
                          					&& panIdOrg[0].position.x == panId[15].position.x && panIdOrg[3].position.x == panId[9].position.x )
                          			...
                          			if(flag1==1 && flag2==1 && flag3==1  && flag4==1 && flag5==1 )
                          			{
										...
										// game.time.events.add(4, this.gameLayout, this);                          				
                          				 //game.time.events.add(4, this.word4, this);
                          				  setTimeout(function(){ game.state.start('game2State3'); }, 3000);
