...
var playState0 = {
	...
	gameLayout: function(){
									...
									home = game.add.image(game.world.centerX-575,game.world.centerY-340,'home');
...
word5:function(){
	...
	word4:function(){
							...
							var prop4= ['P', 'A', 'P', ' ', ' ', 'A'];
								...
								this.prop2 = game.add.sprite(squarePos[17].X-33,squarePos[17].Y-20, 'papaya',0,this.props);
								this.prop2.scale.x = .8;
								this.prop2.scale.y = .8;
	...
	homeAgain: function(){
	   							 ...
	   							 game.add.tween(home.scale).to({x: 0.48, y: 0.48}, 200, Phaser.Easing.Cubic.Out, true);
  								  game.add.tween(home.scale).to({x: 0.6, y: 0.6}, 200, Phaser.Easing.Cubic.Out, true, 200);
	   							
	   							//setTimeout(function(){ game.state.start('game2State0'); }, 300);
	   							setTimeout(function(){ game.state.start('menu'); }, 200);
