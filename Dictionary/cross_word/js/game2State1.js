...
var playState1 = {
	...
	preload: function(){
								...
								game.load.image('panelRep','assets/rep&am/panelRep.png');
								game.load.image('panel1','assets/ansPanel1.png');
								game.load.image('1dark','assets/1dark.png');
								game.load.image('repBg','assets/rep&am/repBg.png');
								game.load.image('home','assets/home.png');
								game.load.image('ant','assets/rep&am/ant.png');
								game.load.image('beetle','assets/rep&am/beetle.png');
								game.load.image('butterfly','assets/rep&am/butterfly.png');
								game.load.image('cockroach','assets/rep&am/cockroach.png');
								game.load.image('crab','assets/rep&am/crab.png');
								game.load.image('dragonfly','assets/rep&am/dragonfly.png');
								game.load.image('fly','assets/rep&am/fly.png');
								game.load.image('frog','assets/rep&am/frog.png');
								game.load.image('scorpion','assets/rep&am/scorpion.png');
								game.load.image('shark','assets/rep&am/shark.png');
								game.load.image('spider','assets/rep&am/spider.png');
								game.load.image('squid','assets/rep&am/squid.png');
	},

	gameLayout: function(){

									this.bg = game.add.image(0,0,'repBg');
									this.bg.alpha= .8;
								...
								this.panel = game.add.image(0,game.world.centerY+230, 'panelRep');
	...
	word3:function(){
							...
							var prop1 = [' ', 'R', 'A', ' ', 'O', 'N', 'F', 'L', ' '];
							var prop2 = ['S', ' ', 'O', 'R', ' ','I',' ', 'N'];
							var prop3= ['A', 'N', ' '];
							//var prop4= ['P', 'A', 'P', ' ', ' ', 'A'];

								this.prop1 = game.add.sprite(squarePos[30].X+10,squarePos[30].Y, 'dragonfly',0,this.props);
								...
								this.prop3 = game.add.sprite(squarePos[26].X-5,squarePos[26].Y-30, 'ant', 0, this.props);
								...
								this.prop2 = game.add.sprite(squarePos[3].X,squarePos[3].Y+10, 'scorpion',0,this.props);
						...
						var d =0
							...
							this.text.anchor.setTo(.5,.5);
								...
								if(i<8)
								{
								var textXprop2 = squarePos[12+c12].X;
								var textYprop2= squarePos[12+c12].Y;
						...
						//console.log(panIdOrg);
							...
							var letterAns = ['A','S', 'D', 'G', 'K', 'Y', 'V', 'H', 'C','O', 'T', 'M', 'N', 'E', 'P', 'F'];
...
word5:function(){
							...
							var prop5=  ['F', ' ', 'Y'];
								...
								this.prop1 = game.add.sprite(squarePos[50].X+18,squarePos[50].Y-30, 'butterfly',0,this.props);
								this.prop1.scale.x = .9;
								this.prop1.scale.y = .9;
								this.prop1.anchor.setTo(.5,.5);
								...
								this.prop3 = game.add.sprite(squarePos[22].X-20,squarePos[22].Y+40, 'beetle', 0, this.props);
								this.prop3.scale.x = .9;
								this.prop3.scale.y = .9;
								this.prop3.anchor.setTo(.5,.5);
								...
								this.prop4 = game.add.sprite(squarePos[5].X-46,squarePos[5].Y-20, 'spider',0,this.props);
								...
								this.prop5 = game.add.sprite(squarePos[24].X-15,squarePos[24].Y-25, 'squid',0,this.props);
								...
								this.prop2 = game.add.sprite(squarePos[37].X-22,squarePos[38].Y, 'fly',0,this.props);
								this.prop2.scale.x = .9;
								this.prop2.scale.y = .9;
						...
						var d =0
							...
							{  
								...
								var textXprop1 = squarePos[61+c1].X;
								var textYprop1 = squarePos[61+c1].Y;
							...
							this.text.anchor.setTo(.5,.5);
								...
								//for papaya square text color
									if(i<5)
									{
								var textXprop4 = squarePos[25+c1].X;
								var textYprop4= squarePos[25+c1].Y;
								...
								if(i<3)
							{
								var textXprop5 = squarePos[49+c12].X;
								var textYprop5= squarePos[49+c12].Y;
						...
						//console.log(panIdOrg);
							...
							var letterAns = ['S','Q', 'L', 'A', 'E', 'F', 'H', 'P', 'C','U', 'R', 'T', 'Y', 'N', 'O', 'D'];
							this.option= game.add.group();
							optionPosx = game.world.centerX-350;
							optionPosy = game.world.centerY+285;
							optionAddx = 0;
	...
	word4:function(){
								...
								this.props = game.add.group();
									...
									game.physics.arcade.enable(this.grid);
							// this.image1.scale.setTo(.5,.5);
							var prop1 = ['C', 'O', ' ', 'K', 'R',' ', 'A', 'C', ' '];
							var prop2 = [' ', 'R', 'O', ' '];
							var prop3= ['S', 'H', ' ', ' ', 'K'];
							var prop4= ['C', 'R', 'A',' '];

								this.prop1 = game.add.sprite(squarePos[50].X+15,squarePos[50].Y-18, 'cockroach',0,this.props);
								this.prop1.scale.x = .9;
								this.prop1.scale.y = .9;
								this.prop1.anchor.setTo(.5,.5);
								...
								this.prop3 = game.add.sprite(squarePos[22].X-5,squarePos[22].Y+25, 'frog', 0, this.props);
								this.prop3.scale.x = .9;
								this.prop3.scale.y = .9;
								this.prop3.anchor.setTo(.5,.5);
								...
								this.prop4 = game.add.sprite(squarePos[4].X-43,squarePos[4].Y-20, 'shark',0,this.props);
								this.prop4.scale.x = .9;
								this.prop4.scale.y = .9;
								...
								this.prop2 = game.add.sprite(squarePos[25].X+50,squarePos[27].Y-10, 'crab',0,this.props);
								this.prop2.scale.x = .9;
								this.prop2.scale.y = .9;
						...
						var d =0
							...
							if(i<4)
							{
								var textXprop2 = squarePos[42+c12].X;
								var textYprop2= squarePos[42+c12].Y;
							...
							this.text.anchor.setTo(.5,.5);
								...
								if(i<4)
								{
								var textXprop4 = squarePos[47+c12].X;
								var textYprop4= squarePos[47+c12].Y;
						...
						//console.log(panIdOrg);
							...
							var letterAns = ['E','G', 'K', 'R', 'S', 'U', 'V', 'O', 'B','H', 'D', 'A', 'J', 'F', 'T', 'C'];
							this.option= game.add.group();
							optionPosx = game.world.centerX-350;
							optionPosy = game.world.centerY+285;
							optionAddx = 0;
...
colorChangeAlpha: function(){
									...
									var flag4 =0;
									 	...
									 	if(  panIdOrg[5].position.x == panId[8].position.x && panIdOrg[5].position.y == panId[8].position.y)
                          	{
                          		...
                          		flag1 = 1;
                   					 ...
                   					 if(panIdOrg[2].position.y == panId[11].position.y && panIdOrg[4].position.y == panId[3].position.y
                          					&& panIdOrg[2].position.x == panId[11].position.x && panIdOrg[4].position.x == panId[3].position.x)
                          			{
						 ...
						 if(panIdOrg[3].position.y == panId[1].position.y  && panIdOrg[0].position.y == panId[13].position.y && 

									panIdOrg[3].position.x == panId[1].position.x  && panIdOrg[0].position.x == panId[13].position.x)

                          			{
                          			 ...
                          			 if(panIdOrg[1].position.y == panId[15].position.y  && panIdOrg[6].position.y == panId[7].position.y 
                          				&& panIdOrg[1].position.x == panId[15].position.x && panIdOrg[6].position.x == panId[7].position.x
                          				&&  panIdOrg[7].position.x == panId[9].position.x && panIdOrg[7].position.y == panId[9].position.y)
                          		{	
                          			...
                          			if(flag1==1 && flag2==1 && flag3==1 && flag4==1)
                          			{
										...
										checkFlag1 = 1;
										 ...
										 game.time.events.add(3000, this.gameLayout, this);                          				
                          				 game.time.events.add(3000, this.word5, this);

                          			}

                          		else {
                          				console.log('else me gaya h colorChangeNew ke GAMA');
                          	    	}
    ...
    colorChangeBeta: function(){
									...
									var flag3 =0;
									 	...
									 	if(  panIdOrg[0].position.y == panId[2].position.y && panIdOrg[3].position.y == panId[3].position.y
                          					&& panIdOrg[0].position.x == panId[2].position.x && panIdOrg[3].position.x == panId[3].position.x 
                          					&& panIdOrg[6].position.x == panId[5].position.x && panIdOrg[6].position.y == panId[5].position.y )
                          	{
                          		panIdOrg[0].inputEnabled = false;
                          				panIdOrg[3].inputEnabled = false;
                          				panIdOrg[6].inputEnabled = false;
                          		...
                          		flag1 = 1;
                   					 ...
                   					 if(panIdOrg[1].position.y == panId[8].position.y && panIdOrg[4].position.y == panId[14].position.y
                          					&& panIdOrg[1].position.x == panId[8].position.x && panIdOrg[4].position.x == panId[14].position.x
                          					&& panIdOrg[5].position.x == panId[9].position.x && panIdOrg[5].position.y == panId[9].position.y)
                          			{
                          				panIdOrg[1].inputEnabled = false;
                          				panIdOrg[4].inputEnabled = false;
                          				panIdOrg[5].inputEnabled = false;
						 ...
						 if( panIdOrg[2].position.y == panId[10].position.y	&& panIdOrg[2].position.x == panId[10].position.x )
                          			...
                          			if(flag1==1 && flag2==1 && flag3==1 )
                          			{
										...
										checkFlag = 1;
										 ...
										 console.log('duniaya se hata do');
										 game.time.events.add(3000, this.gameLayout, this);                          				
                          				 game.time.events.add(3000, this.word4, this);


                          			}

                          		else {
                          				console.log('else me gaya h colorChangeNew BETA');
                          	    	}
    ...
    colorChangeGama: function(){
									...
									var flag5 =0;
									 	...
									 	if(  panIdOrg[5].position.y == panId[11].position.y && panIdOrg[7].position.y == panId[5].position.y
                          					&& panIdOrg[5].position.x == panId[11].position.x && panIdOrg[7].position.x == panId[5].position.x )
                          	{
                          		panIdOrg[5].inputEnabled = false;
                          		ansName[5].kill();
                          		panIdOrg[7].inputEnabled = false;
                          		...
                          		flag1 = 1;
                   					 ...
                   					 if(panIdOrg[1].position.y == panId[7].position.y && panIdOrg[6].position.y == panId[10].position.y
                          					&& panIdOrg[1].position.x == panId[7].position.x && panIdOrg[6].position.x == panId[10].position.x
                          				)
                          			{
                          				panIdOrg[1].inputEnabled = false;
                          				panIdOrg[6].inputEnabled = false;
                          		...
                          		if(panIdOrg[0].position.y == panId[4].position.y 	&& panIdOrg[0].position.x == panId[4].position.x)
							...
							if(panIdOrg[3].position.y == panId[2].position.y 	&& panIdOrg[3].position.x == panId[2].position.x)
                          		...
                          		flag4=1;
                          	     	 ...
                          	     	 if( panIdOrg[2].position.y == panId[1].position.y && panIdOrg[4].position.y == panId[9].position.y
                          					&& panIdOrg[2].position.x == panId[1].position.x && panIdOrg[4].position.x == panId[9].position.x )
                          			...
                          			if(flag1==1 && flag2==1 && flag3==1  && flag4==1 && flag5==1 )
                          			{
										...
										// game.time.events.add(4, this.gameLayout, this);                          				
                          				 //game.time.events.add(4, this.word4, this);
                          				  ...
                          				  setTimeout(function(){ game.state.start('game2State2'); }, 4000);
