...
var playState7= {
	...
	preload: function(){
								...
								game.load.image('panelAuto','assets/automobile/panelAuto.png');
								game.load.image('home','assets/home.png');
								game.load.image('1dark','assets/1dark.png');

								game.load.image('car','assets/automobile/car.png');
								game.load.image('cycle','assets/automobile/cycle.png');
								game.load.image('plane','assets/automobile/plane.png');
								game.load.image('jet','assets/automobile/jet.png');
								game.load.image('ship','assets/automobile/ship.png');
								game.load.image('car','assets/automobile/car.png');
								game.load.image('tractor','assets/automobile/tractor.png');
								game.load.image('truck','assets/automobile/truck.png');
								game.load.image('train','assets/automobile/train.png');
								game.load.image('yatch','assets/automobile/yatch.png');
								game.load.image('rocket','assets/automobile/rocket.png');
								game.load.image('rickshaw','assets/automobile/rickshaw.png');
								game.load.image('autoBg','assets/automobile/autoBg.png');
	},

	gameLayout: function(){

									this.bg = game.add.image(0,0,'autoBg');
									this.bg.alpha= .9;
								...
								this.panel = game.add.image(0,game.world.centerY+230, 'panelAuto');
	...
	word3:function(){
							...
							var prop1 = [' ', 'I', 'C', 'K', ' ', 'H', 'A','W'];
							var prop2=  ['C', ' ', 'C', 'L','E'];
							var prop3 = [' ', 'L', 'A', 'N', ' '];
							//var prop4= ['P', 'A', 'P', ' ', ' ', 'A'];

								this.prop1 = game.add.sprite(squarePos[8].X-10,squarePos[8].Y+25, 'plane',0,this.props);
								...
								this.prop3 = game.add.sprite(squarePos[34].X,squarePos[34].Y-38, 'cycle', 0, this.props);
								...
								this.prop2 = game.add.sprite(squarePos[40].X+20,squarePos[40].Y-15, 'rickshaw',0,this.props);
						...
						var d =0
							...
							this.text.anchor.setTo(.5,.5);
								...
								var textXprop2 = squarePos[4+c12].X;
								var textYprop2= squarePos[44+c12].Y;
						...
						//	this.textOver.add(this.text);
								...
								var textXprop3 = squarePos[28+c12].X;
								var textYprop3= squarePos[28+c12].Y;
						...
						//console.log(panIdOrg);
							...
							var letterAns = ['Y','V', 'J', 'K', 'R', 'X', 'M', 'N', 'P','C', 'Q', 'E', 'S', 'V', 'F', 'G'];
...
word5:function() {
							...
							var prop5=  [' ', 'E', ' '];
								...
								this.prop1 = game.add.sprite(squarePos[41].X-5,squarePos[41].Y-18, 'ship',0,this.props);
								//this.prop1.scale.x = .7;
								//this.prop1.scale.y = .7;
								this.prop1.anchor.setTo(.5,.5);
								...
								this.prop3 = game.add.sprite(squarePos[25].X,squarePos[25].Y+30, 'car', 0, this.props);
								//this.prop3.scale.x = .7;
								//this.prop3.scale.y = .7;
								this.prop3.anchor.setTo(.5,.5);
								...
								this.prop4 = game.add.sprite(squarePos[28].X-20,squarePos[29].Y-27, 'jet',0,this.props);
								...
								this.prop5 = game.add.sprite(squarePos[50].X,squarePos[50].Y, 'papaya',0,this.props);
								...
								this.prop2 = game.add.sprite(squarePos[16].X-20,squarePos[7].Y-8, 'train',0,this.props);
						...
						var d =0
							...
							{  
								...
								var textXprop1 = squarePos[51+c1].X;
								var textYprop1 = squarePos[51+c1].Y;
							...
							if(i<5)	//for peach square text color
							{
							...
							if(i<4)
							{
								var textXprop3 = squarePos[51+c12].X;
								var textYprop3= squarePos[51+c12].Y;
								...
								if(i<3)
								{
								var textXprop4 = squarePos[45+c12].X;
								var textYprop4 = squarePos[45+c12].Y;
						...
						//console.log(panIdOrg);
							...
							var letterAns = ['E','A', 'U', 'T', 'K', 'R', 'N', 'P', 'W','Q', 'C', 'J', 'H', 'I', 'D', 'M'];
							this.option= game.add.group();
							optionPosx = game.world.centerX-350;
							optionPosy = game.world.centerY+285;
							optionAddx = 0;
	...
	word4:function(){
							...
							var prop2 = [' ', 'R', 'A', 'C', 'T', ' ', 'R'];
							 ...
							 var prop4= [' ', 'A', 'T', 'C', ' '];
								...
								this.prop1 = game.add.sprite(squarePos[42].X-15,squarePos[41].Y-18, 'rocket',0,this.props);
								...
								this.prop3 = game.add.sprite(squarePos[72].X+10,squarePos[72].Y-15, 'truck', 0, this.props);
								...
								this.prop4 = game.add.sprite(squarePos[3].X-30,squarePos[4].Y-20, 'tractor',0,this.props);
								...
								this.prop4Tween.start();
									...
									this.prop2 = game.add.sprite(squarePos[7].X,squarePos[7].Y-45, 'yatch',0,this.props);
								this.prop2.scale.x = .9;
								this.prop2.scale.y = .9;
						...
						var d =0
							...
							this.text.anchor.setTo(.5,.5);
								...
								var textXprop2 = squarePos[15+c12].X;
								var textYprop2= squarePos[15+c12].Y;
							...
							this.text.anchor.setTo(.5,.5);
								...
								if(i<5)
								{
								var textXprop3 = squarePos[74+c1].X;
								var textYprop3= squarePos[74+c1].Y;
						...
						//console.log(panIdOrg);
							...
							var letterAns = ['E','R', 'O', 'F', 'H', 'S', 'K', 'T', 'J','M', 'Y', 'U', 'C', 'D', 'M', 'I'];
							this.option= game.add.group();
							optionPosx = game.world.centerX-350;
							optionPosy = game.world.centerY+285;
							optionAddx = 0;
...
colorChangeAlpha: function(){
									...
									var flag4 =0;
									 	...
									 	if(  panIdOrg[3].position.x == panId[11].position.x && panIdOrg[3].position.y == panId[11].position.y)
                          	{
                          		...
                          		flag1 = 1;
                   					 ...
                   					 if( panIdOrg[0].position.y == panId[1].position.y && panIdOrg[0].position.x == panId[1].position.x &&
                          				panIdOrg[4].position.y == panId[6].position.y && panIdOrg[4].position.x == panId[6].position.x	 )
                          			{
						 ...
						 if(panIdOrg[1].position.y == panId[7].position.y  && panIdOrg[6].position.y == panId[2].position.y && 
                                panIdOrg[1].position.x == panId[7].position.x  && panIdOrg[6].position.x == panId[2].position.x)
...

                          			{
                          			 ...
                          			 if(panIdOrg[2].position.y == panId[10].position.y
                          				&& panIdOrg[2].position.x == panId[10].position.x && panIdOrg[5].position.y == panId[4].position.y
                          				&& panIdOrg[5].position.x == panId[4].position.x
                          				)
                          		{	
    ...
    colorChangeBeta: function(){
									...
									var flag3 =0;
									 	...
									 	if(  panIdOrg[0].position.y == panId[4].position.y && panIdOrg[3].position.y == panId[12].position.y
                          					&& panIdOrg[0].position.x == panId[4].position.x && panIdOrg[3].position.x == panId[12].position.x 
                          				)
                          	{
                          				panIdOrg[0].inputEnabled = false;
                          				panIdOrg[3].inputEnabled = false;
                          		...
                          		flag1 = 1;
                   					 ...
                   					 if(panIdOrg[1].position.y == panId[8].position.y && panIdOrg[4].position.y == panId[11].position.y
                          					&& panIdOrg[1].position.x == panId[8].position.x && panIdOrg[4].position.x == panId[11].position.x
                          				)
                          			{
                          				panIdOrg[1].inputEnabled = false;
                          				panIdOrg[4].inputEnabled = false;
						 ...
						 if( panIdOrg[2].position.y == panId[0].position.y	
						 		&& panIdOrg[2].position.x == panId[0].position.x )
    ...
    colorChangeGama: function(){
									...
									var flag5 =0;
									 	...
									 	if(   panIdOrg[7].position.y == panId[5].position.y && panIdOrg[2].position.y == panId[2].position.y
                          					 && panIdOrg[7].position.x == panId[5].position.x  && panIdOrg[2].position.x == panId[2].position.x)
                          	{
                          		panIdOrg[2].inputEnabled = false;
                          		ansName[2].kill();
                          		...
                          		flag1 = 1;
                   					 ...
                   					 if(panIdOrg[3].position.y == panId[12].position.y && panIdOrg[5].position.y == panId[7].position.y
                          					&& panIdOrg[3].position.x == panId[12].position.x && panIdOrg[5].position.x == panId[7].position.x
                          				)
                          			{
                          				panIdOrg[3].inputEnabled = false;
                          				panIdOrg[5].inputEnabled = false;
                          		...
                          		if(panIdOrg[0].position.y == panId[10].position.y 	&& panIdOrg[0].position.x == panId[10].position.x)
							...
							if(panIdOrg[6].position.y == panId[6].position.y 	&& panIdOrg[6].position.x == panId[6].position.x)
                          		...
                          		flag4=1;
                          	     	 ...
                          	     	 if( panIdOrg[1].position.y == panId[11].position.y && panIdOrg[4].position.x == panId[3].position.x
                          	     	 	&&  panIdOrg[1].position.y == panId[11].position.y && panIdOrg[4].position.x == panId[3].position.x
                          				 )
                          			...
                          			if(flag1==1 && flag2==1 && flag3==1  && flag4==1 && flag5==1 )
                          			{
										...
										// game.time.events.add(4, this.gameLayout, this);                          				
                          				 //game.time.events.add(4, this.word4, this);
                          				  ...
                          				  setTimeout(function(){ game.state.start('game2State8'); }, 3000);
