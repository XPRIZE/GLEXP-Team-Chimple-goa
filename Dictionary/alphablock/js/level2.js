...
var position1 = [{x:470, y:145}, {x:575, y:145}, {x:695, y:155}, {x:790, y:140}, {x:465, y:260}, {x:565, y:250}, {x:685, y:260}, {x:795, y:255}, {x:460, y:365}, {x:580, y:370}, {x:675, y:355}, {x:800, y:365}, {x:455, y:465}, {x:576, y:475}, {x:680, y:472}, {x:810, y:482}];
...
/*		game.load.image('a' , 'letters/A.png');
	...
	create : function ()
	{
		...
		consonantArray2 = [];
		chars2=[];
		position1 = [{x:470, y:145}, {x:575, y:145}, {x:695, y:155}, {x:790, y:140}, {x:465, y:260}, {x:565, y:250}, {x:685, y:260}, {x:795, y:255}, {x:460, y:365}, {x:580, y:370}, {x:675, y:355}, {x:800, y:365}, {x:455, y:465}, {x:576, y:475}, {x:680, y:472}, {x:810, y:482}];
		mainarray2 = [];
		...
		this.Red_shadow_tile = game.add.sprite(477, 152, 'Red_shadow_tile');
		this.Red_shadow_tile.anchor.setTo(0.5, 0.5);
		this.Red_shadow_tile.id = 1;

		this.Red_tile = game.add.sprite(470, 145, 'Red_tile');
		this.Red_tile.anchor.setTo(0.5, 0.5);
		this.Red_tile.inputEnabled = true;
		this.Red_tile.events.onInputUp.add(this.group1function);
		this.Red_tile.id = 3;
		this.Red_tile.flag = 0;

		group21 = game.add.group();
		group21.add(this.Red_shadow_tile);
		group21.add(this.Red_tile);

		
		
		this.Blue_shadow_tile1 = game.add.sprite(587, 152, 'Blue_shadow_tile');
		this.Blue_shadow_tile1.anchor.setTo(0.5, 0.5);

		this.Blue_tile_line1_1 = game.add.sprite(580, 145, 'Blue_tile');
		this.Blue_tile_line1_1.anchor.setTo(0.5, 0.5);
		
		this.Blue_tile_line1_2 = game.add.sprite(575, 140, 'Blue_tile');
		this.Blue_tile_line1_2.anchor.setTo(0.5, 0.5);
		this.Blue_tile_line1_2.inputEnabled = true;
		this.Blue_tile_line1_2.events.onInputUp.add(this.group2function);
		this.Blue_tile_line1_2.flag = 0;

		group22 = game.add.group();
		group22.add(this.Blue_shadow_tile1);
		group22.add(this.Blue_tile_line1_1);
		group22.add(this.Blue_tile_line1_2);


		
		this.Special_yellow_shadow_tile = game.add.sprite(697, 152, 'Special_yellow_shadow_tile');
		this.Special_yellow_shadow_tile.anchor.setTo(0.5, 0.5);
		this.Special_yellow_shadow_tile.inputEnabled = true;
		this.Special_yellow_shadow_tile.events.onInputUp.add(this.group3function);
		this.Special_yellow_shadow_tile.flag = 0;
		
		group23 = game.add.group();
		group23.add(this.Special_yellow_shadow_tile);


		
		this.Orange_shadow_tile = game.add.sprite(807, 152, 'Orange_shadow_tile');
		this.Orange_shadow_tile.anchor.setTo(0.5, 0.5);
		
		this.Orange_tile_line1_1 = game.add.sprite(800, 145, 'Orange_tile');
		this.Orange_tile_line1_1.anchor.setTo(0.5, 0.5);

		this.Orange_tile_line1_2 = game.add.sprite(795, 140, 'Orange_tile');
		this.Orange_tile_line1_2.anchor.setTo(0.5, 0.5);
		
		this.Orange_tile_line1_3 = game.add.sprite(790, 135, 'Orange_tile');
		this.Orange_tile_line1_3.anchor.setTo(0.5, 0.5);
		this.Orange_tile_line1_3.inputEnabled = true;
		this.Orange_tile_line1_3.events.onInputUp.add(this.group4function);
		this.Orange_tile_line1_3.flag = 0;
		
		group24 = game.add.group();
		group24.add(this.Orange_shadow_tile);
		group24.add(this.Orange_tile_line1_1);
		group24.add(this.Orange_tile_line1_2);
		group24.add(this.Orange_tile_line1_3);
		
/* second line start */

		this.Special_pink_shadow_tile = game.add.sprite(470, 262, 'Special_pink_shadow_tile');
		this.Special_pink_shadow_tile.anchor.setTo(0.5, 0.5);
		this.Special_pink_shadow_tile.inputEnabled = true;
		this.Special_pink_shadow_tile.events.onInputUp.add(this.group5function);
		this.Special_pink_shadow_tile.flag = 0;
		
		group25 = game.add.group();
		group25.add(this.Special_pink_shadow_tile);
		...
		this.Blue_shadow_tile2 = game.add.sprite(692, 262, 'Blue_shadow_tile');
		this.Blue_shadow_tile2.anchor.setTo(0.5, 0.5);

		this.Blue_tile_line2_1 = game.add.sprite(685, 255, 'Blue_tile');
		this.Blue_tile_line2_1.anchor.setTo(0.5, 0.5);
		this.Blue_tile_line2_1.inputEnabled = true;
		this.Blue_tile_line2_1.events.onInputUp.add(this.group7function);
		this.Blue_tile_line2_1.flag = 0;
		
		group27 = game.add.group();
		group27.add(this.Blue_shadow_tile2);
		group27.add(this.Blue_tile_line2_1);
		...
		this.Red_tile_line2_2.events.onInputUp.add(this.group8function);
...
/* third line start */
		...
		this.Yellow_shadow_tile3 = game.add.sprite(472, 372, 'Yellow_shadow_tile');
		this.Yellow_shadow_tile3.anchor.setTo(0.5, 0.5);

		this.Yellow_tile_line3_1 = game.add.sprite(465, 365, 'Yellow_tile');
		this.Yellow_tile_line3_1.anchor.setTo(0.5, 0.5);
		
		this.Yellow_tile_line3_2 = game.add.sprite(460, 360, 'Yellow_tile');
		this.Yellow_tile_line3_2.anchor.setTo(0.5, 0.5);
		this.Yellow_tile_line3_2.inputEnabled = true;
		this.Yellow_tile_line3_2.events.onInputUp.add(this.group9function);
		this.Yellow_tile_line3_2.flag = 0;

		group29 = game.add.group();
		group29.add(this.Yellow_shadow_tile3);
		group29.add(this.Yellow_tile_line3_1);
		group29.add(this.Yellow_tile_line3_2);
		


		this.Red_shadow_tileg3 = game.add.sprite(582, 372, 'Red_shadow_tile');
		this.Red_shadow_tileg3.anchor.setTo(0.5, 0.5);
		this.Red_shadow_tileg3.inputEnabled = true;
		this.Red_shadow_tileg3.events.onInputUp.add(this.group10function);
		this.Red_shadow_tileg3.flag = 0;

		group210 = game.add.group();
		group210.add(this.Red_shadow_tileg3);


		
		this.Orange_shadow_tileg3 = game.add.sprite(692, 373, 'Orange_shadow_tile');
		this.Orange_shadow_tileg3.anchor.setTo(0.5, 0.5);

		this.Orange_tileg_line3_1 = game.add.sprite(685, 365, 'Orange_tile');
		this.Orange_tileg_line3_1.anchor.setTo(0.5, 0.5);

		this.Orange_tileg_line3_2 = game.add.sprite(680, 360, 'Orange_tile');
		this.Orange_tileg_line3_2.anchor.setTo(0.5, 0.5);
		
		this.Orange_tileg_line3_3 = game.add.sprite(675, 355, 'Orange_tile');
		this.Orange_tileg_line3_3.anchor.setTo(0.5, 0.5);
		this.Orange_tileg_line3_3.inputEnabled = true;
		this.Orange_tileg_line3_3.events.onInputUp.add(this.group11function);
		this.Orange_tileg_line3_3.flag = 0;

		group211 = game.add.group();
		group211.add(this.Orange_shadow_tileg3);
		group211.add(this.Orange_tileg_line3_1);
		group211.add(this.Orange_tileg_line3_2);
		group211.add(this.Orange_tileg_line3_3);
		...
		this.Green_tile_line3_1.events.onInputUp.add(this.group12function);
...
/* fourth line start */
		...
		this.Blue_shadow_tile4 = game.add.sprite(472, 482, 'Blue_shadow_tile');
		this.Blue_shadow_tile4.anchor.setTo(0.5, 0.5);

		this.Blue_tile_line4_1 = game.add.sprite(465, 475, 'Blue_tile');
		this.Blue_tile_line4_1.anchor.setTo(0.5, 0.5);
		
		this.Blue_tile_line4_2 = game.add.sprite(460, 470, 'Blue_tile');
		this.Blue_tile_line4_2.anchor.setTo(0.5, 0.5);
		
		this.Blue_tile_line4_3 = game.add.sprite(455, 465, 'Blue_tile');
		this.Blue_tile_line4_3.anchor.setTo(0.5, 0.5);
		this.Blue_tile_line4_3.inputEnabled = true;
		this.Blue_tile_line4_3.events.onInputUp.add(this.group13function);
		this.Blue_tile_line4_3.flag = 0;

		
		group213 = game.add.group();
		group213.add(this.Blue_shadow_tile4);
		group213.add(this.Blue_tile_line4_1);
		group213.add(this.Blue_tile_line4_2);
		group213.add(this.Blue_tile_line4_3);
		
		
		
		
		this.Orange_shadow_tile4 = game.add.sprite(582, 482, 'Orange_shadow_tile');
		this.Orange_shadow_tile4.anchor.setTo(0.5, 0.5);

		this.Orange_tile_line4_1 = game.add.sprite(575, 475, 'Orange_tile');
		this.Orange_tile_line4_1.anchor.setTo(0.5, 0.5);
		this.Orange_tile_line4_1.inputEnabled = true;
		this.Orange_tile_line4_1.events.onInputUp.add(this.group14function);
		this.Orange_tile_line4_1.flag = 0;

		group214 = game.add.group();
		group214.add(this.Orange_shadow_tile4);
		group214.add(this.Orange_tile_line4_1);
		...
		this.Pink_tile_line4_2.inputEnabled = true;
		this.Pink_tile_line4_2.events.onInputUp.add(this.group15function);
		this.Pink_tile_line4_2.flag = 0;
		...
		this.Yellow_shadow_tile4.inputEnabled = true;
		this.Yellow_shadow_tile4.events.onInputUp.add(this.group16function);
		this.Yellow_shadow_tile4.flag = 0;
...
/*			var count1=0;
			...
			if(count1>=9 && count1<=12)
			{
				...
				if(result==0)
				{
					result = ten(chars2.join(""), 1);
				}
				
				if(result==0)
				{
					result = eleven(chars2.join(""), 1);
				}
				
				if(result==0)
				{
					result = twelve(chars2.join(""), 1);
				}			
			}
*/			
			if(result==0)
			{
                ...
                setTimeout(function(){game.state.start('level3');}, 3000);
