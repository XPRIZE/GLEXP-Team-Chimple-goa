...
var chars=[], letterFunction, text, wrong_button, correct_button, sorryText, calText, score, hintButton, points, wordhint, score_text, Score_board;
...
var level4 = 
{
	preload : function ()
	{
        game.load.image('bg' , 'fwd/Snow_BG.jpg');
	...
	create : function ()
	{
            ...
            position = [{x:510, y:162}, {x:620, y:175}, {x:725, y:180}, {x:528, y:280}, {x:625, y:280}, {x:730, y:285}, {x:525, y:380}, {x:630, y:380}, {x:725, y:380}];        
		...
		this.Blue_shadow_tile_line1 = game.add.sprite(542, 192, 'Blue_shadow_tile');
		this.Blue_shadow_tile_line1.anchor.setTo(0.5, 0.5);
		this.Blue_shadow_tile_line1.id = 1;
//		this.Blue_shadow_tile.scale.setTo(0.2);

		this.Blue_tile_line1_1 = game.add.sprite(535, 185, 'Blue_tile');
		this.Blue_tile_line1_1.anchor.setTo(0.5, 0.5);
		this.Blue_tile_line1_1.id = 2;
	//	this.Blue_tile_line1.scale.setTo(0.2);

		this.Blue_tile_line1_2 = game.add.sprite(530, 180, 'Blue_tile');
		this.Blue_tile_line1_2.anchor.setTo(0.5, 0.5);
        
		this.Blue_tile_line1_3 = game.add.sprite(525, 175, 'Blue_tile');
		this.Blue_tile_line1_3.anchor.setTo(0.5, 0.5);
        
		this.Blue_tile_line1_4 = game.add.sprite(520, 170, 'Blue_tile');
		this.Blue_tile_line1_4.anchor.setTo(0.5, 0.5);
        
		this.Blue_tile_line1_5 = game.add.sprite(515, 165, 'Blue_tile');
		this.Blue_tile_line1_5.anchor.setTo(0.5, 0.5);

        
		this.Blue_tile_line1_6 = game.add.sprite(510, 160, 'Blue_tile');
		this.Blue_tile_line1_6.anchor.setTo(0.5, 0.5); 
		this.Blue_tile_line1_6.inputEnabled = true;
		this.Blue_tile_line1_6.events.onInputUp.add(this.group1function);
		this.Blue_tile_line1_6.id = 3;
		this.Blue_tile_line1_6.flag = 0;
	//	this.Blue_tile_line1_6.scale.setTo(0.2);

		group1 = game.add.group();
		group1.add(this.Blue_shadow_tile_line1);
		group1.add(this.Blue_tile_line1_1);
		group1.add(this.Blue_tile_line1_2);
		group1.add(this.Blue_tile_line1_3);
        group1.add(this.Blue_tile_line1_4);
        group1.add(this.Blue_tile_line1_5);
        group1.add(this.Blue_tile_line1_6);
...
*/		
		...
		this.Pink_shadow_tile_line1 = game.add.sprite(642, 192, 'Pink_shadow_tile');
		this.Pink_shadow_tile_line1.anchor.setTo(0.5, 0.5);
	//	this.Red_shadow_tile.scale.setTo(0.2);

		this.Pink_tile_line1_1 = game.add.sprite(635, 185, 'Pink_tile');
		this.Pink_tile_line1_1.anchor.setTo(0.5, 0.5);

		this.Pink_tile_line1_2 = game.add.sprite(630, 180, 'Pink_tile');
		this.Pink_tile_line1_2.anchor.setTo(0.5, 0.5);
        
		this.Pink_tile_line1_3 = game.add.sprite(625, 175, 'Pink_tile');
		this.Pink_tile_line1_3.anchor.setTo(0.5, 0.5);
        
		this.Pink_tile_line1_4 = game.add.sprite(620, 170, 'Pink_tile');
		this.Pink_tile_line1_4.anchor.setTo(0.5, 0.5);        
        this.Pink_tile_line1_4.inputEnabled = true;
		this.Pink_tile_line1_4.events.onInputUp.add(this.group2function);
		this.Pink_tile_line1_4.flag = 0;
	//	this.Pink_tile_line1_4.Pink_tile_line1_4.setTo(0.2);
...
*/
		...
		group2.add(this.Pink_shadow_tile_line1);
		group2.add(this.Pink_tile_line1_1);
        group2.add(this.Pink_tile_line1_2);
        group2.add(this.Pink_tile_line1_3);
        group2.add(this.Pink_tile_line1_4);
...
*/		
		...
		this.Special_yellow_shadow_tile_line1 = game.add.sprite(742, 192, 'Special_yellow_shadow_tile');
	...
	//	this.Yellow_tile1.scale.setTo(0.2);
		...
		this.Special_yellow_tile3 = game.add.sprite(725, 175, 'Special_yellow_tile');
		this.Special_yellow_tile3.anchor.setTo(0.5, 0.5);        
        this.Special_yellow_tile3.inputEnabled = true;
		this.Special_yellow_tile3.events.onInputUp.add(this.group3function);
		this.Special_yellow_tile3.flag = 0;
	//	this.Yellow_tile2.scale.setTo(0.2);

		group3 = game.add.group();
		group3.add(this.Special_yellow_shadow_tile_line1);
		group3.add(this.Special_yellow_tile1);
		group3.add(this.Special_yellow_tile2);
        group3.add(this.Special_yellow_tile3);
...
/* second line start */
		...
		this.Red_shadow_tile_line2 = game.add.sprite(542, 292, 'Red_shadow_tile');
		this.Red_shadow_tile_line2.anchor.setTo(0.5, 0.5);
        
		this.Red_tile_line2_1 = game.add.sprite(535, 285, 'Red_tile');
		this.Red_tile_line2_1.anchor.setTo(0.5, 0.5);
        
		this.Red_tile_line2_2 = game.add.sprite(530, 280, 'Red_tile');
		this.Red_tile_line2_2.anchor.setTo(0.5, 0.5);
        
		this.Red_tile_line2_3 = game.add.sprite(525, 275, 'Red_tile');
		this.Red_tile_line2_3.anchor.setTo(0.5, 0.5);
		this.Red_tile_line2_3.inputEnabled = true;
		this.Red_tile_line2_3.events.onInputUp.add(this.group4function);
		this.Red_tile_line2_3.flag = 0;
		
		group4 = game.add.group();
		group4.add(this.Red_shadow_tile_line2);
        group4.add(this.Red_tile_line2_1);
        group4.add(this.Red_tile_line2_2);
        group4.add(this.Red_tile_line2_3);
...
*/
		...
		this.Blue_shadow_tile_line2 = game.add.sprite(742, 292, 'Blue_shadow_tile');
		this.Blue_shadow_tile_line2.anchor.setTo(0.5, 0.5);
        
		this.Blue_tile_line2_1 = game.add.sprite(735, 285, 'Blue_tile');
		this.Blue_tile_line2_1.anchor.setTo(0.5, 0.5); 
        
		this.Blue_tile_line2_2 = game.add.sprite(730, 280, 'Blue_tile');
		this.Blue_tile_line2_2.anchor.setTo(0.5, 0.5);
		this.Blue_tile_line2_2.inputEnabled = true;
		this.Blue_tile_line2_2.events.onInputUp.add(this.group6function);
		this.Blue_tile_line2_2.flag = 0;

		group6 = game.add.group();
		group6.add(this.Blue_shadow_tile_line2);
        group6.add(this.Blue_tile_line2_1);
        group6.add(this.Blue_tile_line2_2);
...
/* third line start */
		...
		this.Pink_shadow_tile_line3 = game.add.sprite(542, 392, 'Pink_shadow_tile');
		this.Pink_shadow_tile_line3.anchor.setTo(0.5, 0.5);

		this.Pink_tile_line3_1 = game.add.sprite(535, 385, 'Pink_tile');
		this.Pink_tile_line3_1.anchor.setTo(0.5, 0.5);
        
		this.Pink_tile_line3_2 = game.add.sprite(530, 380, 'Pink_tile');
		this.Pink_tile_line3_2.anchor.setTo(0.5, 0.5);
        
		this.Pink_tile_line3_3 = game.add.sprite(525, 375, 'Pink_tile');
		this.Pink_tile_line3_3.anchor.setTo(0.5, 0.5);
		this.Pink_tile_line3_3.inputEnabled = true;
		this.Pink_tile_line3_3.events.onInputUp.add(this.group7function);
		this.Pink_tile_line3_3.flag = 0;

		group7 = game.add.group();
		group7.add(this.Pink_shadow_tile_line3);
		group7.add(this.Pink_tile_line3_1);
        group7.add(this.Pink_tile_line3_2);
        group7.add(this.Pink_tile_line3_3);
...
*/		
		...
		this.Yellow_tile3 = game.add.sprite(625, 375, 'Yellow_tile');
		this.Yellow_tile3.anchor.setTo(0.5, 0.5);
        this.Yellow_tile3.inputEnabled = true;
		this.Yellow_tile3.events.onInputUp.add(this.group8function);
		this.Yellow_tile3.flag = 0;

		group8 = game.add.group();
		group8.add(this.Yellow_shadow_tile);
		group8.add(this.Yellow_tile1);
		group8.add(this.Yellow_tile2);
        group8.add(this.Yellow_tile3);
...
*/		
        ...
        score_text = game.add.text(game.world.centerX, game.world.centerY-50, '0', style);
        score_text.alpha = 0;
...
/*			var count1=0;
        ...
        */
			...
			if(result==0)
			{
                ...
                setTimeout(function(){game.state.start('level5');}, 3000);
...
//				game.state.start('level2');
      ...
      //          score.text = vv*10 + parseInt(score.text);
         //       setTimeout(function(){game.state.start('level5');}, 1600*(vv+1));
			}
