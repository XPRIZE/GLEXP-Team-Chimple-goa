var play4State = {
	...
	create: function() { 
        ...
        this.displayimage = game.add.image(70, 350, 'A');
 ...
 removeTileGroup: function(matches){
    ...
    for(var i = 0; i < matches.length; i++){
        ...
        for(var j = 0; j < tempArr.length; j++){
            ...
            this.displayimage = game.add.image(70, 350, tile.key);
            if(tile.key=='A')
