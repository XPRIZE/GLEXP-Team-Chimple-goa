var play3State = {
	...
	create: function() { 
        ...
        this.displayimage = game.add.image(70, 390, 'A');
    ...
    me.tiles.position.x += 360;
    me.tiles.position.y += 70;    
    ...
    me.createScore();
        ...
        me.emitter=game.add.emitter(120,420,30);
    ...
    if(me.activeTile1 && !me.activeTile2){
       ...
       var hoverX = me.game.input.x - 360;
        var hoverY = me.game.input.y -70;
 ...
 removeTileGroup: function(matches){
    ...
    for(var i = 0; i < matches.length; i++){
        ...
        for(var j = 0; j < tempArr.length; j++){
            ...
            this.displayimage = game.add.image(70, 390, tile.key);
            if(tile.key=='A')
