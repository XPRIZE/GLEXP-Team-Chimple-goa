var play6State = {
	...
	create: function() { 
        ...
        this.displayimage = game.add.image(50, 350, 'A');
    ...
    me.tiles.position.x += 400;
    me.tiles.position.y += 110;    
    ...
    me.createScore();
        ...
        me.emitter=game.add.emitter(110,440,30);
    ...
    if(me.activeTile1 && !me.activeTile2){
       ...
       var hoverX = me.game.input.x - 400;
        var hoverY = me.game.input.y -110;
 ...
 //alert('l'+me.tileGrid[0].length);
    ...
    //Once the tiles are ready, check for any matches on the grid
     if(me.score<=25){    
    me.game.time.events.add(2000, function(){
        me.checkMatch();
   });
     }
},
 ...
 removeTileGroup: function(matches){
    ...
    for(var i = 0; i < matches.length; i++){
        ...
        for(var j = 0; j < tempArr.length; j++){
            ...
            this.displayimage = game.add.image(50, 350, tile.key);
            if(tile.key=='A')
  ...
  getTilePos: function(tileGrid, tile)
{
  ...
  createScore: function(){
    ...
    me.scoreLabel = me.game.add.text(120,200, '0', {font: scoreFont, fill: "#ffff"}); 
