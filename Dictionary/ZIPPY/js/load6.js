var load6State = {
	...
	preload: function () {
        ...
        game.load.image('A', 'assets/a-06.png');
        game.load.image('B', 'assets/b-06.png');
        game.load.image('C', 'assets/c-06.png'); 
        game.load.image('D', 'assets/d-06.png');
        game.load.image('E', 'assets/e-06.png');
       ...
       // game.load.image('p', 'assets/Star.png');
        ...
        game.load.image('background', 'assets/Cupcake_Level.png');
