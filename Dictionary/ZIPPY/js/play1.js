var play1State = {
	...
	create: function() { 
        ...
        me.f=game.add.audio('fs'); 
        me.i=game.add.audio('is'); 
 
        this.displayimage = game.add.image(70, 450, 'A');
    ...
    me.createScore();
        ...
        me.emitter=game.add.emitter(100,530,30);
       ...
       var hoverX = me.game.input.x - 300;
        ...
        if(!(hoverPosY > me.tileGrid[0].length - 1 || hoverPosY < 0) && !(hoverPosX > me.tileGrid.length - 1 || hoverPosX < 0)){
            ...
            if((Math.abs(difY) == 1 && difX == 0) || (Math.abs(difX) == 1 && difY ==0)){
                ...
                if(me.score<=25){
                me.game.time.events.add(1700, function(){
                    me.checkMatch();
                });
                }
            }
 ...
 removeTileGroup: function(matches){
    ...
    for(var i = 0; i < matches.length; i++){
        ...
        for(var j = 0; j < tempArr.length; j++){
            ...
            this.displayimage = game.add.image(70, 450, tile.key);
            if(tile.key=='A')
...
incrementScore: function(){
    ...
    if(me.score >=25)
     {
          //var text = game.add.text(10,300, 'hellow rold', {fill: "#ffff"}); 
