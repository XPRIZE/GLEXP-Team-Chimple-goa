var load4State = {
	...
	preload: function () {
        ...
        game.load.image('A', 'assets/A-04.png');
        game.load.image('B', 'assets/B-04.png');
        game.load.image('C', 'assets/C-04.png'); 
        game.load.image('D', 'assets/D-04.png');
        game.load.image('E', 'assets/E-04.png');
        ...
        game.load.image('background', 'assets/Toy_Train.png');
