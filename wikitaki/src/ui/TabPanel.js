...
// for tab bar
       ...
       this.tabBar_backButton = new ccui.Button("back.png", "back_onclick.png", null, ccui.Widget.PLIST_TEXTURE);
       ...
       this.tabBar_nextButton = new ccui.Button("next.png", "next_onclick.png", null, ccui.Widget.PLIST_TEXTURE);
    ...
    selectPanelForTabName: function(name) {
        ...
        this._configuration.forEach(function(element) {
            if(element['icon'] == name) {
                ...
                // for tab panel
                this._panelPosition.y = this._panelPosition.y - this._tabHeight;
                this.tabPanel_backButton = new ccui.Button("back.png", "back_onclick.png", null, ccui.Widget.PLIST_TEXTURE);
                ...
                this.tabPanel_nextButton = new ccui.Button("next.png", "next_onclick.png", null, ccui.Widget.PLIST_TEXTURE);
                ...
                this.main_backButton = new ccui.Button("back.png", "back_onclick.png", null, ccui.Widget.PLIST_TEXTURE);
