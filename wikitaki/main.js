...
(function () {
    ...
    cc.game.onStart = function () {
        ...
        cc.LoaderScene.preload(g_resources, function () {
            ...
            cc.spriteFrameCache.addSpriteFrames(res.human_skeleton_01_plist);            
            cc.spriteFrameCache.addSpriteFrames(res.human_skeleton_02_plist);            
            cc.spriteFrameCache.addSpriteFrames(res.human_skeleton_03_plist);            
