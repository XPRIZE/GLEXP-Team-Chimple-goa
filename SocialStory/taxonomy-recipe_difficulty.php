<?php
/* Difficulty recipe archive
 *
 * The template for displaying a page with recipes categorized by difficulty
 * @package WordPress
...
?>
	<div class="row">
		<header class="s-title">
			<h1 class="archive-title"><?php printf( __( 'Difficulty Archives: %s', 'socialchef' ), single_cat_title( '', false ) ); ?></h1>
		</header>
