<?php
/* Meal course recipe archive
 *
 * The template for displaying a page with recipes categorized by meal course
 * @package WordPress
...
?>
	<div class="row">
		<header class="s-title">
			<h1 class="archive-title"><?php printf( __( 'Meal Course Archives: %s', 'socialchef' ), single_cat_title( '', false ) ); ?></h1>
		</header>
