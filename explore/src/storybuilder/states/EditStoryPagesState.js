...
export default class EditStoryPagesState extends Phaser.State {
    ...
    addNewPage() {
        ...
        let page = new Page(game, 0, 0, pName, scene, this._currentStory.storyId, defaultPageImage);
        this._pagesGrid.addButton(EditStoryPagesState.NEW_PAGE_IMAGE_KEY, null, null, null);
        this._currentStory.addStoryPage(page);
        this.saveToLocalStore();
    }
