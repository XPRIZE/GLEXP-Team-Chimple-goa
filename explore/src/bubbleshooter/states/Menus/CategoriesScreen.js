class CategoriesScreen extends Phaser.State{
    preload(){
        this.game.load.image('Background','assets/bubbleshooter/categoryBackground.png');

        this.game.load.image('Animal','assets/bubbleshooter/Animal_Button.png');
        this.game.load.image('Fruit','assets/bubbleshooter/Fruit_Button.png');
        this.game.load.image('Vegitable','assets/bubbleshooter/Vegetable_Button.png');
