...
class Puzzle extends Phaser.State {
      ...
      for (let i=0; i < this.level.columns ;  i++) {
       ...
       // Define a level width and height
        ...
        if(this.game._LevelFlag ==  1){        
            this.levelName = "PuzzleStarLevel1";            
            this.hits = 50;
            this.letterSprite = ['A','B','C'];
            ...
            this.levelName = "PuzzleStarLevel2";            
            this.hits = 50;
            ...
            this.levelName = "PuzzleStarLevel3";            
            this.hits = 50;
            ...
            this.levelName = "PuzzleStarLevel4";            
            this.hits = 50;
            ...
            this.levelName = "PuzzleStarLevel5";            
            this.hits = 50;
            ...
            this.levelName = "PuzzleStarLevel6";            
            this.hits = 50;
            ...
            this.levelName = "PuzzleStarLevel7";            
            this.hits = 50;
            ...
            this.levelName = "PuzzleStarLevel8";            
            this.hits = 60;
            ...
            this.levelName = "PuzzleStarLevel9";            
            this.hits = 60;            
            let color = 4 , repeat = 2;
            ...
            this.levelName = "PuzzleStarLevel10";            
            this.hits = 80;
            ...
            this.levelName = "PuzzleStarLevel11";            
            this.hits = 80;
            ...
            this.levelName = "PuzzleStarLevel12";            
            this.hits = 200;
        ...
        for (let j=0; j < this.level.rows; j++) {
            for (let i=0; i < this.level.columns; i++) {
                ...
                if (tile.type >= 0) {
                    ...
                    this.bubbleName[i][j] = this.drawBubbleGroups( coord.tilex, coord.tiley + shift, tile.type );
                    this.LetterName[i][j] = this.drawLetterGroups( coord.tilex, coord.tiley + shift, tile.type );
 ...
 //   this.pageText.anchor.set(0.5);    
    ...
    nextButton(){
        ...
        this.game.state.start('Bubble_Puzzle');
    }
