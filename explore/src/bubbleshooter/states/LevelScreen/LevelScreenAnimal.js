class LevelScreenFruit extends Phaser.State{
    ...
    create(){
       ...
       // ----- ODD BUBBLE RENDERING ----
         ...
         dataDimension = this.getValueXY(34,18);
          if(localStorage.getItem('AnimalStarLevel1') > 0){
             let star = "Star"+localStorage.getItem('AnimalStarLevel1');
         ...
         dataDimension = this.getValueXY(34,31);
          if(localStorage.getItem('AnimalStarLevel3') > 0){
             let star = "Star"+localStorage.getItem('AnimalStarLevel3');
         ...
         if(localStorage.getItem('AnimalStarLevel5') > 0){
             let star = "Star"+localStorage.getItem('AnimalStarLevel5');
         ...
         dataDimension = this.getValueXY(34,57);
          if(localStorage.getItem('AnimalStarLevel7') > 0){
             let star = "Star"+localStorage.getItem('AnimalStarLevel7');
         ...
         dataDimension = this.getValueXY(34,70);
          if(localStorage.getItem('AnimalStarLevel9') > 0){
             let star = "Star"+localStorage.getItem('AnimalStarLevel9');
         ...
         dataDimension = this.getValueXY(34,83);
          if(localStorage.getItem('AnimalStarLevel11') > 0){
             let star = "Star"+localStorage.getItem('AnimalStarLevel11');
         ...
         dataDimension = this.getValueXY(84,18);
          if(localStorage.getItem('AnimalStarLevel2') > 0){
             let star = "Star"+localStorage.getItem('AnimalStarLevel2');
         ...
         dataDimension = this.getValueXY(84,31);
          if(localStorage.getItem('AnimalStarLevel4') > 0){
             let star = "Star"+localStorage.getItem('AnimalStarLevel4');
         ...
         dataDimension = this.getValueXY(84,44);
          if(localStorage.getItem('AnimalStarLevel6') > 0){
             let star = "Star"+localStorage.getItem('AnimalStarLevel6');
         ...
         dataDimension = this.getValueXY(84,57);
          if(localStorage.getItem('AnimalStarLevel8') > 0){
             let star = "Star"+localStorage.getItem('AnimalStarLevel8');
         ...
         dataDimension = this.getValueXY(84,70);
          if(localStorage.getItem('AnimalStarLevel10') > 0){
             let star = "Star"+localStorage.getItem('AnimalStarLevel10');
         ...
         dataDimension = this.getValueXY(84,83);
          if(localStorage.getItem('AnimalStarLevel12') > 0){
             let star = "Star"+localStorage.getItem('AnimalStarLevel12');
    ...
    LevelMethod1(){
     ...
     this.game.state.start('Bubble_Animals');
