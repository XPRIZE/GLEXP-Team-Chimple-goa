...
preload () {
		...
		this.game.load.image('Background', 'assets/whack_a_mole/Background/Play3_BG.png');
        this.game.load.image('Hole_Back', 'assets/whack_a_mole/Background/Play3_Hole_Back.png');
        this.game.load.image('Hole_Front', 'assets/whack_a_mole/Background/Play3_Hole_Front.png');
        this.game.load.tilemap('map', 'assets/whack_a_mole/Background/newBack.json', null, Phaser.Tilemap.TILED_JSON);
    ...
    create () {
        this.game.state.start ('whack_a_play3');
