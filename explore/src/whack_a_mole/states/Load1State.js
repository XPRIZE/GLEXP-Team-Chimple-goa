...
preload () {
		...
		this.game.load.image('Background', 'assets/whack_a_mole/Background/Play5_BG.png');
        this.game.load.image('Hole_Back', 'assets/whack_a_mole/Background/Play5_Hole_Back.png');
        this.game.load.image('Hole_Front', 'assets/whack_a_mole/Background/Play5_Hole_Front.png');
        this.game.load.tilemap('map', 'assets/whack_a_mole/Background/newBack5.json', null, Phaser.Tilemap.TILED_JSON);
    ...
    create () {
        ...
        this.game.state.start('whack_a_play1');
    }
