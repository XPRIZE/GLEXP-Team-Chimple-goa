...
(function (dragonBones) {
    ...
    (function (animation) {
        ...
        var Animation = (function () {
            ...
            Animation.prototype.gotoAndPlay = function (animationName, fadeInTime, duration, loop, layer, group, fadeOutMode, displayControl, pauseFadeOut, pauseFadeIn) {
                ...
                if (typeof fadeOutMode === "undefined") {
                    fadeOutMode = Animation.SAME_LAYER_AND_GROUP;
                }
                if (typeof displayControl === "undefined") {
                    displayControl = true;
                }
                if (typeof pauseFadeOut === "undefined") {
                    pauseFadeOut = true;
                }
                if (typeof pauseFadeIn === "undefined") {
                    pauseFadeIn = true;
                }
    ...
    (function (objects) {
        var DBTransform = (function () {
            ...
            DBTransform.prototype.copy = function (transform) {
                ...
                this.maskX = transform.maskX;
                this.maskY = transform.maskY;
            };
    ...
    var Armature = (function (_super) {
        ...
        Armature.prototype.getSlots = function (returnCopy) {
            if (typeof returnCopy === "undefined") {
                returnCopy = true;
            }
