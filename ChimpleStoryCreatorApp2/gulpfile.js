...
var paths = {
  ...
  libs: [
    ...
    './app/js/loki-angular/lokiIndexedAdapter.js',
    './app/js/loki-angular/lokijs.js',
    './app/js/loki-angular/lokiAngular.js',
    './app/js/dragonBones/dragonBones.js',
    './app/js/dragonBones/phaserDragonBones.js',
...
gulp.task('fast', ['clean'], function () {
  gulp.start('browserify', 'copylibs');
});
