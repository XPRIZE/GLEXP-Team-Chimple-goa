...
public:
    ...
    void buttonSelected(cocos2d::Ref* pSender, cocos2d::ui::Widget::TouchEventType eEventType);
    
CC_CONSTRUCTOR_ACCESS:
    MultipleChoice();
    virtual ~MultipleChoice();
    virtual bool init() override;
    bool initWithQuestions(QuestionHandler* qHandler, std::vector<std::string> questions);
