...
static const vector<string> allLowerStrings = {
    "అ", "ఆ", "ఇ", "ఈ", "ఉ", "ఊ", "ఋ", "ఌ", "ఎ", "ఏ", "ఐ", "ఒ", "ఓ", "ఔ", "ಂ", "ಃ", "క", "ఖ", "గ", "ఘ", "ఙ", "చ", "ఛ", "జ", "ఝ", "ఞ", "ట", "ఠ", "డ", "ఢ", "ణ", "త", "థ", "ద", "ధ", "న", "ప", "ఫ", "బ", "భ", "మ", "య", "ర", "ల", "వ", "శ", "ష", "స", "హ", "ళ"
};
...
static const vector<vector<string>> wordsByLength = {
    ...
    {"ద","క్ష","జా","ప","తి"},
    {"దం","డ","క","వి","లె","లు"},
    {"దం","డ","చ","క్ర","న్యా","య","ము"},
    {"ద","గ్ధ","ర","శ","నా","న్యా","య","ము"},
    {"అం","గా","ర","ప","రి","పా","చి","త","ము"},
    {"దం","డ","స","ర్ప","మా","ర","ణ","న్యా","య","ము"}
};
