...
cocos2d::Scene * SmashTheRockLevelScene::createScene()
{
	...
	auto layer = SmashTheRockLevelScene::create();
...
bool SmashTheRockLevelScene::init()
{
	//////////////////////////////
	// 1. super init first
	if (!Layer::init())
...
/*	auto emitter = ParticleFireworks::create();
	...
	listener->onTouchBegan = CC_CALLBACK_2(SmashTheRockLevelScene::onTouchBegan, this);
	listener->onTouchMoved = CC_CALLBACK_2(SmashTheRockLevelScene::onTouchMoved, this);
	listener->onTouchEnded = CC_CALLBACK_2(SmashTheRockLevelScene::onTouchEnded, this);
	listener->onTouchCancelled = CC_CALLBACK_2(SmashTheRockLevelScene::onTouchCancelled, this);
...
void SmashTheRockLevelScene::menuCloseCallback(Ref* pSender)
{
...
bool SmashTheRockLevelScene::onTouchBegan(cocos2d::Touch *touch, cocos2d::Event * event)
{
	...
	for (auto iter = children.rbegin(); iter != children.rend(); ++iter) {
		...
		//	auto scene = SmashTheRockLevelScene::createScene();
...
void SmashTheRockLevelScene::onTouchMoved(cocos2d::Touch *touch, cocos2d::Event * event)
{
...
void SmashTheRockLevelScene::onTouchEnded(cocos2d::Touch *touch, cocos2d::Event * event)
{
	//isTouching = false;
}
void SmashTheRockLevelScene::onTouchCancelled(cocos2d::Touch *touch, cocos2d::Event * event)
{
