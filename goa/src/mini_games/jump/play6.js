...
//cc.log(cc.FileUtils.getInstance().getStringFromFile(xc.playLayer.res.jump_plist));
        ...
        square1.setPosition(cc.p(this.ballref[0].x,this.ballref[1].y+260));
        ...
        square2.setPosition(cc.p(this.ballref[1].x,this.ballref[2].y+260));
        ...
        square3.setPosition(cc.p(this.ballref[2].x,this.ballref[3].y+260));
        ...
        square4.setPosition(cc.p(this.ballref[3].x,this.ballref[4].y+260));
        ...
        square5.setPosition(cc.p(this.ballref[4].x,this.ballref[4].y+260));
        this.addChild(square5,1);
        this.square.push(square5.getPosition());

        var square6 =new cc.Sprite(cc.spriteFrameCache.getSpriteFrame("jump_on_words/box.png"));
        square6.setPosition(cc.p(this.ballref[5].x,this.ballref[4].y+260));
        this.addChild(square6,1);
  ...
  // dict = ["abc","dsa","cba","bda","hsf"];
    ...
    verify : function (word)
    {
     ...
     cc.log("done= %s" , words);
     for(var i=0 ; i< this.dict6.length ; i++)
     {   
       if(this.dict6[i].indexOf(words.toLowerCase()) != -1)
        {
         cc.log("oooo");
         this.jumping();
          cc.log( this.dict6.splice( i ,1));
   ...
   remove : function(index)
  {
    ...
    jumping : function()
    {
     ...
     help : function ()
     {
         cc.log("hiint");
        this.decrementScore();
        this.random = Math.floor(Math.random()*(this.dict6.length-1));  
        var nameLabel = new cc.LabelTTF(this.dict6[this.random].toUpperCase(),"res/fonts/Marker Felt.ttf", 100 );
   ...
   decrementScore : function()
   {
    ...
    onTouchBegan: function(touch, event){
         ...
         if (cc.rectContainsPoint(targetRectangle, location))
                   {
                       if(target.id == "Ball1" && self.word.length < 6){ 
                        ...
                        if(target.id == "Ball2"&& self.word.length < 6){ 
                        ...
                        if(target.id == "Ball3"&& self.word.length < 6){ 
                        ...
                        if(target.id == "Ball4"&& self.word.length < 6){ 
                        ...
                        if(target.id == "Ball5"&& self.word.length < 6){ 
                        ...
                        if(target.id == "Ball6"&& self.word.length < 6){ 
