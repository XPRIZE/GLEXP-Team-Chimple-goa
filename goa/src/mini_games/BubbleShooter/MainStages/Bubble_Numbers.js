            ...
            for (let i=0; i < this.cluster.length; i++) {
                ...
                if (tile.type >= 0) {
                    ...
                    if (tile.alpha == 0) {
                        ...
                        if(i != 0 ){
                            this.playerDie(tile.x,tile.y,tempColorType);
                        }
...
var NumbersScene = cc.Scene.extend({
    
    onEnter : function () {
        this._super();
      
        var numbersScene = new Numbers();
        
        this.addChild(numbersScene);
    }
});