...
var CategoryMenu = cc.Layer.extend({
    ...
    ctor:function () {
        ...
        this.LevelBox1button = new ClickedButtonToRedirect("Orange_LevelBall.png","categoryGame",1);
        ...
        this.LevelBox3button = new ClickedButtonToRedirect("Orange_LevelBall.png","categoryGame",3);
        ...
        this.LevelBox5button = new ClickedButtonToRedirect("Orange_LevelBall.png","categoryGame",5);
        ...
        this.LevelBox7button = new ClickedButtonToRedirect("Orange_LevelBall.png","categoryGame",7);
        ...
        this.LevelBox9button = new ClickedButtonToRedirect("Orange_LevelBall.png","categoryGame",9);
        ...
        // this.LevelBox11button = new cc.Sprite("Orange_LevelBall.png");
        this.LevelBox11button = new ClickedButtonToRedirect("Orange_LevelBall.png","categoryGame",11);
        this.Level11button = new cc.Sprite(cc.spriteFrameCache.getSpriteFrame("lvl11.png"));
        this.LevelBox11button.setPosition(cc.director.getWinSize().width * 0.1125 ,cc.director.getWinSize().height * 0.1015625);
        this.Level11button.setPosition(cc.director.getWinSize().width * 0.1125 ,cc.director.getWinSize().height * 0.1015625);
        this.LevelBox11button.id = "AlphabetsLevelBox11button";
        this.Level11button.id ="Alphabetslvl11";
        // cc.eventManager.addListener(allButtonClickedlistener.clone(), this.LevelBox11button);
        this.addChild(this.LevelBox11button);
        this.addChild(this.Level11button);
        ...
        this.Level11Star = new cc.Sprite(cc.spriteFrameCache.getSpriteFrame("Star1.png"));
        this.Level11Star.setPosition(cc.director.getWinSize().width * 0.3475 ,cc.director.getWinSize().height * 0.1015625);
        this.Level11Star.id = "Level11Star";
        this.addChild(this.Level11Star);
        
       // NumberButton for Even Button
       
       
        // this.LevelBox2button = new cc.Sprite("Orange_LevelBall.png");
        this.LevelBox2button = new ClickedButtonToRedirect("Orange_LevelBall.png","categoryGame",2);
        ...
        this.LevelBox4button = new ClickedButtonToRedirect("Orange_LevelBall.png","categoryGame",4);
        ...
        this.LevelBox6button = new ClickedButtonToRedirect("Orange_LevelBall.png","categoryGame",6);
        ...
        this.LevelBox8button = new ClickedButtonToRedirect("Orange_LevelBall.png","categoryGame",8);
        ...
        this.LevelBox10button = new ClickedButtonToRedirect("Orange_LevelBall.png","categoryGame",10);
        ...
        // this.LevelBox12button = new cc.Sprite("Orange_LevelBall.png");
        this.LevelBox12button = new ClickedButtonToRedirect("Orange_LevelBall.png","categoryGame",12);
        this.Level12button = new cc.Sprite(cc.spriteFrameCache.getSpriteFrame("lvl12.png"));
        this.LevelBox12button.setPosition(cc.director.getWinSize().width * 0.6 ,cc.director.getWinSize().height * 0.1015625);
        this.Level12button.setPosition(cc.director.getWinSize().width * 0.6 ,cc.director.getWinSize().height * 0.1015625);
        this.LevelBox12button.id = "AlphabetsLevelBox12button";
        this.Level12button.id ="Alphabetslvl12";
        // cc.eventManager.addListener(allButtonClickedlistener.clone(), this.LevelBox12button);
        this.addChild(this.LevelBox12button);
        this.addChild(this.Level12button);
        ...
        this.Level12Star = new cc.Sprite(cc.spriteFrameCache.getSpriteFrame("Star1.png"));
        this.Level12Star.setPosition(cc.director.getWinSize().width * 0.845 ,cc.director.getWinSize().height * 0.1015625);
        this.Level12Star.id = "Level12Star";
        this.addChild(this.Level12Star);
...
var CategoryMenuScene = cc.Scene.extend({
    onEnter:function () {
        this._super();
        
        var categoryScreenMenu = new CategoryMenu();
        this.addChild(categoryScreenMenu);
    }
});